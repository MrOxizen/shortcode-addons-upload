...
class Style_1 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
                'sa_cd_txt_color', $this->style, [
            'label' => __('Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#545454',
            'selector' => [
                '{{WRAPPER}} .sa-addons-count-down-content .sa-addons-countdown-periodsa-addons-countdown-period' => 'color: {{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
                'sa_cd_txt_typho', $this->style, [
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .sa-addons-count-down-content .sa-addons-countdown-periodsa-addons-countdown-period' => ''
            ],
                ]
        );
        $this->add_responsive_control(
                'sa_cd_txt_padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-count-down-content .sa-addons-countdown-periodsa-addons-countdown-period' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-counter-days.shortcode-addons-count-number .sa-addons-countdown-periodsa-addons-countdown-period' => 'color: {{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_control(
                'sa_cd_hours_txt_sps', $this->style, [
            'label' => __('Separate Settings', SHORTCODE_ADDOONS),
            'type' => Controls::SWITCHER,
            'loader' => TRUE,
            'label_on' => __('Yes', SHORTCODE_ADDOONS),
        ...
        $this->add_control(
                'sa_cd_hours_num_color', $this->style, [
            'label' => __('Number Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#f29993',
            'condition' => [
        ...
        $this->add_control(
                'sa_cd_hours_txt_color', $this->style, [
            'label' => __('Text Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#545454',
            'condition' => [
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-counter-hours.s-a-count-hours .sa-addons-countdown-periodsa-addons-countdown-period' => 'color: {{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_control(
                'sa_cd_min_num_color', $this->style, [
            'label' => __('Number Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#f29993',
            'condition' => [
        ...
        $this->add_control(
                'sa_cd_min_txt_color', $this->style, [
            'label' => __('Text Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#545454',
            'condition' => [
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-counter-minutes.s-a-count-minute .sa-addons-countdown-periodsa-addons-countdown-period' => 'color: {{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_control(
                'sa_cd_seco_num_color', $this->style, [
            'label' => __('Number Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#f29993',
            'condition' => [
        ...
        $this->add_control(
                'sa_cd_seco_txt_color', $this->style, [
            'label' => __('Text Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#545454',
            'condition' => [
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-counter-seconds.s-a-count-second .sa-addons-countdown-periodsa-addons-countdown-period' => 'color: {{VALUE}};'
            ],
                ]
        );
