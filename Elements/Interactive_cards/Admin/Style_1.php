...
class Style_1 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => ' width : {{SIZE}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => 'height : {{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#000000',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => 'background : {{VALUE}}; '
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => 18,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => 'font-size:{{VALUE}}px',
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-container .oxi-addons-Interactive-card .oxi-close-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->end_controls_section();
