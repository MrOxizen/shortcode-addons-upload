...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_group_control(
            ...
            'loader' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding ' => '',
            ]
                ]
        );

        $this->add_repeater_control(
                'sa_testimonial_data_style_4', $this->style, [
            ...
            'fields' => [
                ...
                'sa_testi_profile_picture' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-testifournew-image-{{key}} ' => '',
                    ]
                ],
                'sa_testi_profile_name' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-testifournew-name-{{key}} ' => '',
                    ]
                ],
                'sa_testi_profile_company' => [
                    ...
                    'placeholder' => 'Upwork',
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-testifournew-working-{{key}} ' => '',
                    ]
                ],
                ...
                'sa_testi_profile_description' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-testifournew-info-{{key}} ' => '',
                    ]
                ],
            ],
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-item-testifournew' => 'max-width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew' => '',
            ]
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-image' => 'max-width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-image, {{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-image img' => 'height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-image img, {{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew' => '',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-image img' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-name' => 'color: {{VALUE}};',
            ]
                ]
        );
        $this->add_group_control(
            ...
            'separator' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-name' => '',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-name' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-info' => 'color: {{VALUE}};',
            ]
                ]
        );
        $this->add_group_control(
            ...
            'separator' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-info' => '',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-info' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-working a' => 'color: {{VALUE}};',
            ]
                ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            'separator' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-working' => '',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testifournew-padding .oxi-testimonials-style-testifournew-working' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
