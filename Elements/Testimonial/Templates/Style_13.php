...
class Style_13 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($styledata['sa_image_accordion_data_style_13'] as $key => $value) {
            $image = $info = $rating = $name = $company = '';
            if ($this->media_render('sa_testi_profile_picture', $value) != '') {
                $image = ' <div class="oxi-testimonials-style-therteen-image oxi-testimonials-style-therteen-image-'.$key.'">                               
            ...
            if (array_key_exists('sa_testi_profile_description', $value) && $value['sa_testi_profile_description'] != '') {
                $info = '<div class="oxi-testimonials-style-therteen-info oxi-testimonials-style-therteen-info-'.$key.'">
            ...
            if (array_key_exists('sa_testi_profile_name', $value) && $value['sa_testi_profile_name'] != '') {
                if (array_key_exists('sa_testi_profile_name_url-url', $value) && $value['sa_testi_profile_name_url-url'] != '') {
                    $name = '<a ' . $this->url_render('sa_testi_profile_name_url', $value) . ' class="oxi-testimonials-style-therteen-name oxi-testimonials-style-therteen-name-'.$key.'">
                                ' . $this->text_render($value['sa_testi_profile_name']) . ' 
                            </a>';
                } else {
                    $name = '<div  class="oxi-testimonials-style-therteen-name oxi-testimonials-style-therteen-name-'.$key.'">
                                ' . $this->text_render($value['sa_testi_profile_name']) . ' 
                            </div>';
                }
            }
            if (array_key_exists('sa_testi_profile_company', $value) && $value['sa_testi_profile_company'] != '') {
                $company = '<div class="oxi-testimonials-style-therteen-working oxi-testimonials-style-therteen-working-'.$key.'">
