...
class Style_3 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo ' <div class="link-effect-main-style3">
                   <a ' . $this->url_render('sa_link_link', $style) . 'class="oxi-links-effects-style3" ' . $this->animation_render('sa_link_animation', $style) . '>' . $text . '</a>
                </div>';
    }
