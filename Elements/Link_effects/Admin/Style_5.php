...
class Style_5 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5' => 'justify-content:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5' => '',
                ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#00000',
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5' => 'color:{{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5-span::before' => ''
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#2c36c7',
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5-span::before' => 'color:{{VALUE}};',
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5:hover' => 'color:{{VALUE}};',
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5:focus' => 'color:{{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::TEXTSHADOW,
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5 .oxi-links-effects-style5:hover' => '',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
