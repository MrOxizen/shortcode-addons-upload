...
//    }
    ...
    public function old_render() {
        ...
        echo oxi_addons_public_waypoints();
        wp_enqueue_script('jquery-asProgressdfs-js-style-2', SA_ADDONS_UPLOAD_URL . '/Elements/Progress_bars/File/jquery-asProgress.min.js', true, SA_ADDONS_PLUGIN_VERSION);
        $css = '';
        $jquery = '';
