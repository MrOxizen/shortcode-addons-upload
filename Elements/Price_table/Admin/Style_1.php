    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-1 .oxi-addons-ribon' => 'left:{{SIZE}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-1 .oxi-addons-ribon' => 'transform: rotate({{SIZE}}deg) ;'
                ],
            ]
        );
        $this->add_responsive_control(
