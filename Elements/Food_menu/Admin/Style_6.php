...
//         start
        ...
        $this->add_responsive_control(
                'sa-fm-box-out-side-border-radius', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-box-animation-temp-6', $this->style, [
            'type' => Controls::ANIMATION,
                ]
        );
        $this->add_responsive_control(
                'sa_fm_outer_side_box_padding', $this->style, [
        ...
        $this->add_group_control(
                'oa-sa-fm-border-box-inner-border', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-box-round-image-border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
