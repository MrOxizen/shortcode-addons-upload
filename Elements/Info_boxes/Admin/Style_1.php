    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_info_info_box_media' => [
                    'label' => esc_html__('Media', SHORTCODE_ADDOONS),
                    'type' => Controls::MEDIA,
                ...
                'sa_info_info_box_title' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi_addons__info_boxes_main_style_1_{{KEY}} .oxi_addons__heading_style_1' => '',
                    ],
                ],
                'sa_info_info_box_title' => [
                    'label' => esc_html__('Title', SHORTCODE_ADDOONS),
                ...
                'sa_info_info_box_desc' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi_addons__info_boxes_main_style_1_{{KEY}} .oxi_addons__details_style_1' => '',
                    ],
                ],
            ],
                ]
        ...
        $this->add_group_control(
                'sa_info_boxes_animation', $this->style, [
