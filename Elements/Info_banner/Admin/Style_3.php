...
class Style_3 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            'sa_info_banner_sub_heading_text',
            $this->style,
            [
        ...
        $this->add_control(
            'sa_info_banner_sub_heading_tag',
            $this->style,
            [
                'label' => __('Tag', SHORTCODE_ADDOONS),
                'type' => Controls::SELECT,
        ...
        $this->add_group_control(
            'sa_info_banner_sub_heading_typo',
            $this->style,
            [
                'label' => __('Typography', SHORTCODE_ADDOONS),
                'type' => Controls::TYPOGRAPHY,
        ...
        $this->add_control(
            'sa_info_banner_sub_heading_color',
            $this->style,
            [
                'label' => __('Color', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->add_control(
            'sa_info_banner_sub_heading_span_color',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa_info_banner_sub_heading_padding',
            $this->style,
            [
                'label' => __('Padding', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        $this->add_group_control(
            'sa_info_banner_sub_heading_animation',
            $this->style,
            [
