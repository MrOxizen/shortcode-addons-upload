...
namespace SHORTCODE_ADDONS_UPLOAD\Elements\Image_accordion\Admin;
...
class Style_2 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion' => 'max-width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-link, {{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-overlay' => 'height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->start_controls_section(
         ...
         $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-link' => 'justify-content: {{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-heading' => '',
            ]
                ]
        );
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-heading' => 'color: {{VALUE}};',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-heading' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-details' => '',
            ]
                ]
        );
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-details' => 'color: {{VALUE}};',
            ]
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-image-two-accordion .oxi-addons-accordion .oxi-addons-details' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->end_controls_section();
