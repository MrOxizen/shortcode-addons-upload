...
class Style_10 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        $midlin_cls = (array_key_exists('sa_btn_icon_position', $style)?'sa-icon-left' : 'sa-icon-right');
        $icon = (array_key_exists('sa_btn_icon', $style) ? '<div class="oxi-btn-icon ' . (array_key_exists('sa_btn_midline', $style)? $midlin_cls : '' ) . '">' . $this->font_awesome_render($style['sa_btn_icon_class']) . '</div>' : '');
