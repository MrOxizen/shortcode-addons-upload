...
class Style_8 extends Templates {
    ...
    public function inline_public_css() {
        ...
        if (array_key_exists('sa_btn_icon_position', $style)) {
            $position = '.' . $this->WRAPPER . ' .oxi-addons-align-btn8 .oxi-button-btn8 .oxi-icons {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '  <div class="oxi-addons-align-btn8">
                    <a ' . $this->url_render('sa_btn_link', $style) . ' class="oxi-button-btn8 ' . (array_key_exists('sa_btn_width_choose', $style) ? $style['sa_btn_width_choose'] : '') . ' " >' . $html . '</a>
                </div>
                ';
    }
