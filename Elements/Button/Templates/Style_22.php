...
class Style_22 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '  <div class="oxi-addons-align-btn22">
                    <a ' . $this->animation_render('sa_btn_animation', $style) . ' ' . $this->url_render('sa_btn_link', $style) . ' class="oxi-button-btn22 ' . (array_key_exists('sa_btn_icon_position', $style) && $style['sa_btn_icon_position'] != '0' ? 'sa-left-to-right' : 'sa-right-to-left') . '" >' . $html . '</a>
                </div>
                ';
    }
    ...
    $css .= '.oxi-addons-align-' . $oxiid . '{
            ...
            .oxi-button-' . $oxiid . ':hover .oxi-btn-bg-round{
                   ...
                   -moz-border-radius: '. OxiAddonsPaddingMarginSanitize($styledata, 161).';
                   -webkit-border-radius: '. OxiAddonsPaddingMarginSanitize($styledata, 161).';
    ...
    if($styledata[5] == 1){
            ...
            .oxi-button-' . $oxiid . ':hover .oxi-btn-txt{
                    transform: translate(-'.$styledata[205].'% , -50%);
                    position: absolute;
                    color: '.$styledata[113].';
            }
        ...
        $css .= ' @media only screen and (min-width : 669px) and (max-width : 993px){
            ...
            .oxi-button-' . $oxiid . ':hover .oxi-btn-bg-round{
                    width: calc(100% - 10px);
                    -moz-border-radius: '. OxiAddonsPaddingMarginSanitize($styledata, 162).';
                   -webkit-border-radius: '. OxiAddonsPaddingMarginSanitize($styledata, 162).';
    ...
    if($styledata[5] == 1){
            ...
            .oxi-button-' . $oxiid . ':hover .oxi-btn-txt{
                    transform: translate(-'.$styledata[206].'% , -50%);
                    position: absolute;
            }
            .oxi-button-' . $oxiid . ':hover .oxi-btn-icon{
                    right: 26px;
...
$css .= '}
        ...
        @media only screen and (max-width : 668px){
            ...
            .oxi-button-' . $oxiid . ':hover .oxi-btn-bg-round{
                    width: calc(100% - 10px);
                    -moz-border-radius: '. OxiAddonsPaddingMarginSanitize($styledata, 163).';
                   -webkit-border-radius: '. OxiAddonsPaddingMarginSanitize($styledata, 163).';
    ...
    if($styledata[5] == 1){
            ...
            .oxi-button-' . $oxiid . ':hover .oxi-btn-txt{
                    transform: translate(-'.$styledata[207].'% , -50%);
                    position: absolute;
            }
            .oxi-button-' . $oxiid . ':hover .oxi-btn-icon{
                    right: 26px;
