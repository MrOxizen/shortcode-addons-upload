...
//            echo '</pre>';
            ...
            $content = '<div class="oxi-addons-main-wrapper-style-2 oxi-addons-main-wrapper-style-2-' . $key . ' " >
                          
                            ' . $img_ver_position . '
                        </div>';
            echo '<div class="oxi-addons-info-image-parent-wrapper-style-2 ' . $this->column_render('sa_info_image_column', $style) . '">
