...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxi-addons-eventwidgets-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddonsHeaders-RS-P') . ''
                                ...
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddonsHeaders-RS-P', 43, $styledata, 1, 'Padding', 'Set Headers  padding', 'true', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-wrapper-right-side', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_Text_Align('OxiAddonsHeaders-Line-position', $styledata[351], 'Line Position', 'Set Headers Line position', 'true', '', '');
                                            echo OxiAddonsADMHelpNoJquery(
                                                    array(
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsHeaders-H-O-FS', $styledata[156], $styledata[157], $styledata[158], '1', 'Font Size', 'Set Headers Heading Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-heading-one', 'font-size');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsHeaders-H-T-FS', $styledata[123], $styledata[124], $styledata[125], '1', 'Font Size', 'Set Headers Heading Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-heading-two', 'font-size');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddonsHeaders-SD-FS', $styledata[90], $styledata[91], $styledata[92], '2', 'Font Size', 'Set Headers Short details Font Size', 'false', '.oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-short-detail', 'font-size');
