...
class Style_1 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-single-image-container .oxi-addons-single-image img' => '-webkit-filter : {{SIZE}}{{UNIT}}; filter : {{SIZE}}{{UNIT}}; '
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-single-image-container .oxi-addons-single-image:hover img ' => '-webkit-filter : {{SIZE}}{{UNIT}}; filter : {{SIZE}}{{UNIT}}; '
            ],
                ]
        );
        $this->add_control(
