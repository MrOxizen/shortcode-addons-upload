...
class Style_1 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            'sa-progress-bar-content-box-col',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa_image_progress_bar_boxshadow',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa_image_progress_bar_animation',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-progress-bar-back-max-height',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-progress-bar-font-max-height',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-progress-bar-back-border-radius',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-progress-bar-font-border-radius',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa_image_progress_bar_inside_boxshadow',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa-progress-bar-name-typograpy',
            $this->style,
            [
        ...
        $this->add_control(
            'sa-progress-bar-name-text-color',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa-progress-bar-name-text-shadow',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa-progress-bar-percent-typograpy',
            $this->style,
            [
                'type' => Controls::TYPOGRAPHY,
                'selector' => [
        ...
        $this->add_control(
            'sa-progress-bar-percent-text-color',
            $this->style,
            [
                'label' => __('Color', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->add_group_control(
            'sa-progress-bar-percent-text-shadow',
            $this->style,
            [
                'type' => Controls::TEXTSHADOW,
                'selector' => [
        ...
        $this->add_responsive_control(
            'sa-progress-bar-percent-padding',
            $this->style,
            [
                'label' => __('Padding', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
