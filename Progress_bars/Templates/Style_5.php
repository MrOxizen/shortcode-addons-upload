...
//        wp_enqueue_style('oxi-addons-main-wrapper-image-comparison-style-5', SA_ADDONS_UPLOAD_URL . '/Image_comparison/File/twentytwenty.css', false, SA_ADDONS_PLUGIN_VERSION);
//    }
    ...
    public function public_jquery() {
        ...
        wp_enqueue_script('jquery-asProgressdfs-style-5-js', SA_ADDONS_UPLOAD_URL . '/Progress_bars/File/jquery-asProgress.min.js', true, SA_ADDONS_PLUGIN_VERSION);
    }
    ...
    public function old_render() {
        ...
        wp_enqueue_style('Image_effects_global_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style.css', false, SA_ADDONS_PLUGIN_VERSION);
        wp_enqueue_script('jquery-asProgress-style-5', SA_ADDONS_UPLOAD_URL . '/Progress_bars/File/jquery-asProgress.min.js', true, SA_ADDONS_PLUGIN_VERSION);
        $css = '';
        $jquery = '';
