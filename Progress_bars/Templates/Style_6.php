...
//        wp_enqueue_style('oxi-addons-main-wrapper-image-comparison-style-6', SA_ADDONS_UPLOAD_URL . '/Image_comparison/File/twentytwenty.css', false, SA_ADDONS_PLUGIN_VERSION);
//    }
    ...
    public function public_jquery() {
        ...
        wp_enqueue_script('jquery-asProgressdfs-style-6-js', SA_ADDONS_UPLOAD_URL . '/Progress_bars/File/jquery-asProgress.min.js', true, SA_ADDONS_PLUGIN_VERSION);
    }
    ...
    public function old_render() {
        ...
        echo oxi_addons_public_waypoints();
        wp_enqueue_script('jquery-asProgress-style-6', SA_ADDONS_UPLOAD_URL . '/Progress_bars/File/jquery-asProgress.min.js', true, SA_ADDONS_PLUGIN_VERSION);
        $css = '';
        $jquery = '';
