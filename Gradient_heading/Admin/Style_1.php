    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-gradient-heading' => '',
                ],
            ]
        );
        ...
        $this->add_control(
            'sa_head_gradient_heading_alignment',
            $this->style,
            [
                ...
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-gradient-heading-container-style-1 ' => 'text-align:{{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#252b25',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-gradient-heading-container-style-1 .oxi-addons-gradient-heading' => 'background-image:{{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-gradient-heading-container-style-1 .oxi-addons-gradient-heading' => '',
                ],
            ]
        ); 
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-gradient-heading-container-style-1 .oxi-addons-gradient-heading-main' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        ); 
        $this->add_group_control(
