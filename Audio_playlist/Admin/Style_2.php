    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_ap_list_container_style_2 .jp-volume-bar' => 'background: {{VALUE}} !important;'
                ],
                'condition' => [
                    'sa_ap_list_vol_pro_on_off' => 'yes'
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_ap_list_container_style_2 .jp-volume-bar-value' => 'background: {{VALUE}} !important;'
                ],
                'condition' => [
                    'sa_ap_list_vol_pro_on_off' => 'yes'
                ]
