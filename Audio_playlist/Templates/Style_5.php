...
class Style_5 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        if (array_key_exists('sa_ap_list_main_vol_on_off', $style) && $style['sa_ap_list_main_vol_on_off'] != '0') {
            $volume_control .= '
            <div class="sa_addons_jp_main sa_addons_jp_main_' . $oxiid . '">
        ...
        echo '<div class="sa_addons_ap_list_container_style_5 ">
                <div class="sa_addons_ap_list_main " ' . $this->animation_render('sa_ap_list_animation', $style) . '>
                    ...
                    <div id="jp_container_' . $oxiid . '" class="jp-audio" role="application" aria-label="media player">
                        <div class="sa_addons_ap_list_img"> </div>  

                        <div class="sa_addons_ap_list_main_content">
                            <div class="jp-type-playlist">
                                <div class="jp-gui jp-interface">
                                    ' . $suffle_repeat . '
                                    <div class="sa_addons_ap_list_time_progress">
                                        ' . $time_control . '  
                                    </div>
                                    <div class="sa_addons_ap_list_inline">
                                        <div class="sa_addons_ap_list_show_playlist" id="sa_addons_ap_list_show_playlist_' . $oxiid . '">
                                                ' . $this->font_awesome_render($style['sa_ap_list_playlist_icon']) . '
                                        </div>
                                        <div class="jp-controls-holder">
                                            ' . $player_control . '
                                        </div> 
                                        <div class="sa_addons_ap_list_volume_query">
                                        ' . $volume_control . '  
                                        <div id="sa_addons_ap_list_volume_' . $oxiid . '" class="sa_addons_ap_list_volume"></div>
                                    </div>
                                    </div> 
                                </div>
            ...
            ';
        $this->inline_css .= '.' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-type-playlist .jp-previous::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_pre_icon'] != '' ? $this->style['sa_ap_list_audio_pre_icon'] : '') . '" !important;
            ' . $previous_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-type-playlist .jp-play::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_play_icon'] != '' ? $this->style['sa_ap_list_audio_play_icon'] : '') . '" !important;
            ' . $play_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-state-playing div.jp-type-playlist .jp-play::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_paus_icon'] != '' ? $this->style['sa_ap_list_audio_paus_icon'] : '') . '" !important;
            ' . $pause_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-type-playlist .jp-stop::before, .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-type-playlist .jp-stop:focus::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_stop_icon'] != '' ? $this->style['sa_ap_list_audio_stop_icon'] : '') . '" !important;
            ' . $stop_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-type-playlist .jp-next::before, .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-type-playlist .jp-next:focus::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_next_icon'] != '' ? $this->style['sa_ap_list_audio_next_icon'] : '') . '" !important;
            ' . $next_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-audio .jp-volume-controls .jp-mute::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_min_icon'] != '' ? $this->style['sa_ap_list_audio_min_icon'] : '') . '" !important;
            ' . $min_volume_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-state-muted .jp-volume-controls .jp-mute::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_mut_icon'] != '' ? $this->style['sa_ap_list_audio_mut_icon'] : '') . '" !important;
            ' . $mute_volume_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-volume-controls .jp-volume-max::before, .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .sa_addons_ap_list_volume::before  {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_max_icon'] != '' ? $this->style['sa_ap_list_audio_max_icon'] : '') . '" !important;
            ' . $max_volume_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-repeat::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_rep_icon'] != '' ? $this->style['sa_ap_list_audio_rep_icon'] : '') . '" !important;
            ' . $repeat_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_5 .jp-shuffle::before {
    ...
    public function inline_public_jquery() {
        ...
        $jquery .= '
        jQuery("#sa_addons_ap_list_volume_' . $oxiid . '").on("click",function(){
            jQuery(".sa_addons_jp_main_' . $oxiid . '").fadeToggle(100);
        });
        jQuery("#sa_addons_ap_list_show_playlist_' . $oxiid . ' > .oxi-icons").on("click",function(){
