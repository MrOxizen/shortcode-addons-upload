...
class Style_2 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '<div class="sa_addons_ap_list_container_style_2 ">
            ...
            ';
        $this->inline_css .= '.' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-type-playlist .jp-previous::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_pre_icon'] != '' ? $this->style['sa_ap_list_audio_pre_icon'] : '') . '" !important;
            ' . $previous_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-type-playlist .jp-play::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_play_icon'] != '' ? $this->style['sa_ap_list_audio_play_icon'] : '') . '" !important;
            ' . $play_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-state-playing div.jp-type-playlist .jp-play::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_paus_icon'] != '' ? $this->style['sa_ap_list_audio_paus_icon'] : '') . '" !important;
            ' . $pause_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-type-playlist .jp-stop::before, .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-type-playlist .jp-stop:focus::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_stop_icon'] != '' ? $this->style['sa_ap_list_audio_stop_icon'] : '') . '" !important;
            ' . $stop_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-type-playlist .jp-next::before, .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-type-playlist .jp-next:focus::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_next_icon'] != '' ? $this->style['sa_ap_list_audio_next_icon'] : '') . '" !important;
            ' . $next_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-audio .jp-volume-controls .jp-mute::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_min_icon'] != '' ? $this->style['sa_ap_list_audio_min_icon'] : '') . '" !important;
            ' . $min_volume_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-state-muted .jp-volume-controls .jp-mute::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_mut_icon'] != '' ? $this->style['sa_ap_list_audio_mut_icon'] : '') . '" !important;
            ' . $mute_volume_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-volume-controls .jp-volume-max::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_max_icon'] != '' ? $this->style['sa_ap_list_audio_max_icon'] : '') . '" !important;
            ' . $max_volume_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-repeat::before {
            content: "\\' . $this->text_render($this->style['sa_ap_list_audio_rep_icon'] != '' ? $this->style['sa_ap_list_audio_rep_icon'] : '') . '" !important;
            ' . $repeat_type . ';
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_list_container_style_2 .jp-shuffle::before {
