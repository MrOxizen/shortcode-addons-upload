...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
                'sa-is-btn-text-color', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-is-btn-br-radius', $this->style, [
        ...
        $this->add_group_control(
                'sa-is-btn-tx-shadow', $this->style, [
        ...
        $this->add_group_control(
                'sa_is_btn_box_shadow', $this->style, [
        ...
        $this->start_controls_tab();
        $this->add_control(
                'sa-is-btn-text-h-color', $this->style, [
            'label' => __('Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#ffffff',
            'selector' => [
        ...
        $this->add_responsive_control(
                'sa-is-btn-hover-br-radius', $this->style, [
            'label' => __('Border radius', SHORTCODE_ADDOONS),
            'separator' => FALSE,
            'type' => Controls::DIMENSIONS,
            'default' => [
        ...
        $this->add_group_control(
                'sa-is-btn-h-tx-shadow', $this->style, [
            'type' => Controls::TEXTSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-image-scroll-4 .oxi-addons-main-button .oxi-addons-link:hover' => ''
            ],
        ...
        $this->add_group_control(
                'sa_is_btn_h_box_shadow', $this->style, [
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-image-scroll-4 .oxi-addons-main-button .oxi-addons-link:hover' => ''
            ],
