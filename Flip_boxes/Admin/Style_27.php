...
class Style_27 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-27 .oxi-addons-flip-box-front-icon' => 'justify-content: {{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .oxi-addons-flip-box-style-27 .oxi-addons-flip-box-back-button ' => '',
            ]
                ]
        );
