...
class Style_28 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
                'sa_flip_boxes_data_style_28', $this->style, [
            ...
            'fields' => [
                ...
                'sa_flip_boxes_media' => [
                    ...
                    'default' => [
                        'type' => 'media-library',
                        'link' => 'https://www.oxilab.org/wp-content/uploads/2019/05/back-girl.jpg',
                    ]
                ],
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-28' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-flip-box-style-28 .oxi-addons-flip-box-front-img::after' => 'padding-bottom:{{SIZE}}{{UNIT}};',
             ],
                ]
        );
