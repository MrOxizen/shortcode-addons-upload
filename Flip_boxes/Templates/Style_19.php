...
class Style_19 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($styledata['sa_flip_boxes_data_style_19'] as $key => $value) {
            ...
            echo '  <div class="oxi-flip-box-col-style-19 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ">
    ...
    foreach ($listdata as $value) {
        ...
        if ($data[5] != '') {
            $button .= '<div class="oxi-addons-flip-box-back-button">
                            <a href="' . OxiAddonsUrlConvert($data[7]) . '" class="oxi-addons-flip-box-back-link" >' . oxi_addons_font_awesome($data[5]) . '</a>
                        </div>';
        }
    ...
    $css = '
        ...
        .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link .oxi-icons {
        ...
        .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-back-link .oxi-icons:hover {
            color: ' . $styledata[319] . ';
