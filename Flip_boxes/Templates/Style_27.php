...
class Style_27 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($styledata['sa_flip_boxes_data_style_27'] as $key => $value) {
            ...
            echo '  <div class="oxi-flip-box-col-style-27 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ">
                        <div class="oxi-addons-flip-box-style-27">
                            '.$bt.'
    ...
    $css = '
        ...
        .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon {
            padding: ' . OxiAddonsPaddingMarginSanitize($styledata, 419) . ';
            text-align: center;
            width: 100%;
        }
        ...
        @media only screen and (min-width : 669px) and (max-width : 993px){
            ...
            .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon {
                padding: ' . OxiAddonsPaddingMarginSanitize($styledata, 420) . ';
            }
            .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons {
        ...
        @media only screen and (max-width : 668px){
            ...
            .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon {
                padding: ' . OxiAddonsPaddingMarginSanitize($styledata, 421) . ';
            }
            .oxi-addons-flip-box-' . $oxiid . ' .oxi-addons-flip-box-front-icon .oxi-icons {
