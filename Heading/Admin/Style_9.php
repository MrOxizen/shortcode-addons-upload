    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text' => '',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-sub-heading-style-9 .oxi-addons-sub-heading-text' => '',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#1f0c0c',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text' => 'color:{{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text::before' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text::after' => 'height: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            'shortcode-addons-line-width',
            $this->style,
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text::before' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text::after' => 'width: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text::before' => 'background:{{VALUE}};',
                    '{{WRAPPER}} .oxi-addons-heading-style-9 .oxi-addons-heading-text::after' => 'background:{{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#4d4d4d',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-sub-heading-style-9 .oxi-addons-sub-heading-text' => 'color:{{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-sub-heading-style-9 .oxi-addons-sub-heading-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
