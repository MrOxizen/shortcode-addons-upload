    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_el_insert_food_name' => [
                        ...
                        'type' => Controls::TEXT,
                        'default' => 'Price Tag Food',
                        'selector' => [
                            '{{WRAPPER}} .sa-fm-temp-1 .oxi-addons-fm-box-outer-{{KEY}} .oxi-addonsFM-heading' => '',
                        ],
                    ],
                    'sa_el_insert_price' => [
                        ...
                        'default' => '16',
                        'selector' => [
                            '{{WRAPPER}} .sa-fm-temp-1 .oxi-addons-fm-box-outer-{{KEY}} .oxi-addonsFM-date' => '',
                        ],
                    ],
                    'sa_el_price_link' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addons-admin-edit-list' => '',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addons-fm-box-outer.sa-max-w-auto' => 'max-width:{{SIZE}}{{UNIT}};'
                ],
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addonsFM-row' => ''
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addonsFM-row' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addonsFM-row' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addonsFM-row' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section(); 
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addonsFM-heading' => 'background:{{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'sa-fm-box-price-box-background',
            $this->style,
            [
                'label' => __('Background', SHORTCODE_ADDOONS),
                'type' => Controls::GRADIENT, 
                'selector' => [
                    '{{WRAPPER}} .sa-fm-temp-1 .oxi-addonsFM-image-price' => 'background:{{VALUE}};'
                ],
            ]
        );
        $this->add_control(
            'sa-fm-body-price-alignment',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-ac-box-price-box-border-radius',
            $this->style,
            [
                'label' => __('Border Radius', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
