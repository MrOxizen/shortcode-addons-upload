...
//         start
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_el_insert_food_name' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oa_shortcode_inner_div_{{KEY}} .oxi-addonsFM-FV-heading' => '',
                    ],
                ],
                'sa_el_insert_food_info' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oa_shortcode_inner_div_{{KEY}} .oxi-addonsFM-FV-info' => '',
                    ],
                ],
                'sa_el_insert_price' => [
                    ...
                    'default' => '27',
                    'selector' => [
                        '{{WRAPPER}} .oa_shortcode_inner_div_{{KEY}} .oxi-addonsFM-FV-price' => '',
                    ],
                ],
                'sa_el_insert_rating_name' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oa_shortcode_inner_div_{{KEY}} .oxi-addonsFM-FV-rating' => '',
                    ],
                ],
                'sa_el_price_link' => [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oa_shortcode_inner_div.sa-max-w-auto' => 'max-width:{{SIZE}}{{UNIT}};'
            ],
            'condition' => [
        ...
        $this->add_control(
                'sa-fm-box-bg-outside-color', $this->style, [
            'label' => __('Background', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'oparetor' => 'RGB',
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi-addonsFM-FV-row' => 'background:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsFM-FV-row' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
                'sa_fm_out_side_box_padding', $this->style, [
            ...
            'selector' => [
                '{{WRAPPER}} .oa_shortcode_inner_div' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
                'sa-fm-box-inside-background', $this->style, [
        ...
        $this->add_responsive_control(
                'sa_fm_box_content_side_padding', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-fm-image-height-ratio', $this->style, [
        ...
        $this->add_group_control(
                'sa-ac-heading-h-typho', $this->style, [
        ...
        $this->add_group_control(
                'sa-ac-heading-text-shadow', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-fm-heading-heading-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_control(
                'oa-sa-fm-price-color', $this->style, [
            'label' => __('Font Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-price-typho', $this->style, [
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-b-price-border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oa-fm-style-5 .oxi-addonsFM-FV-price' => ''
            ],
        ...
        $this->add_responsive_control(
                'oa-sa-fm-price-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_responsive_control(
                'oa-sa-fm-rating-font-size', $this->style, [
        ...
        $this->add_control(
                'oa-sa-fm-rating-color', $this->style, [
            'label' => __('Font Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_responsive_control(
                'oa-sa-fm-rating-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_control(
                'oa-sa-fm-info-color', $this->style, [
            'label' => __('Font Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-info-typho', $this->style, [
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-info-text-shadow', $this->style, [
            'type' => Controls::TEXTSHADOW,
            'selector' => [
                '{{WRAPPER}} .oa-fm-style-5 .oxi-addonsFM-FV-info' => ''
            ],
        ...
        $this->add_responsive_control(
                'oa-sa-fm-info-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
