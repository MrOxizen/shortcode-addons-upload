...
//         start
        ...
        $this->add_group_control(
                'sa-fm-box-animation-temp-9', $this->style, [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oa_fm_style_9' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
                'oa-sa-fm-9-heading-color', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-9-heading-h-typho', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-9-heading-text-shadow', $this->style, [
        ...
        $this->add_control(
                'oa_fm-9_heading_text_align', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-fm-9-heading-heading-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_control(
                'oa-sa-fm-9-price-color', $this->style, [
            'label' => __('Font Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-9-price-typho', $this->style, [
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
        ...
        $this->add_group_control(
                'sa-fm-9-price-text-shadow', $this->style, [
            'type' => Controls::TEXTSHADOW,
            'selector' => [
                '{{WRAPPER}} .oa_fm_style_9 .oxi-addonsFM-TH-price' => ''
            ],
        ...
        $this->add_group_control(
                'oa-sa-fm-9-price-border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
        ...
        $this->add_control(
                'oa_sa_fm-9_price_text_align', $this->style, [
            'label' => __('Text Align', SHORTCODE_ADDOONS),
            'type' => Controls::CHOOSE,
            'operator' => Controls::OPERATOR_ICON,
            'toggle' => TRUE,
        ...
        $this->add_responsive_control(
                'oa-sa-fm-9-price-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
