...
class Style_7 extends AdminStyle
{
    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_el_food_box_image' => [
                        ...
                        'default' => [
                            'type' => 'media-library',
                            'link' => 'https://www.shortcode-addons.com/wp-content/uploads/2019/06/oxi-food-8-1.jpeg',
                        ],
                        'controller' => 'add_group_control',
                    ],
                ],
        ...
        $this->add_responsive_control(
            'sa-fm-box-main-image-border-radius',
            $this->style,
            [
        ...
        $this->add_control(
            'sa-fm-tem-7-background-condition',
            $this->style,
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    ...
                    '{{WRAPPER}} .oxiAddons_foodMenu_temPlate_7 .oxi-addonsFM-SV-C-sape:before, .oxiAddons_foodMenu_temPlate_7 .oxi-addonsFM-SV-C-sape:after' => 'background: radial-gradient(closest-side,{{VALUE}},{{VALUE}} 50%,transparent 50%); background-size:40px 50px; background-position:30px 24px; background-repeat:repeat-x;',
                    '{{WRAPPER}} .oxiAddons_foodMenu_temPlate_7 .oxi-addonsFM-SV-C-sape:after' => 'background:  radial-gradient(closest-side,transparent,transparent 50%, {{VALUE}} 50%); background-size:40px 50px; background-position:10px -25px; background-repeat:repeat-x ;'
                ],
            ]
        );
        $this->add_group_control(
            'oa-sa-fm-border-box-bottom-content-border',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-fm-box-bottom-content-border-radius',
            $this->style,
            [
                'label' => __('Border Radius', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        $this->add_responsive_control(
            'sa_fm_box_content_side_inner_margin',
            $this->style,
            [
