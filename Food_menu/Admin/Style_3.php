    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    'sa_el_food_box_image' => [
                        ...
                        'default' => [
                            'type' => 'media-library',
                            'link' => 'https://www.shortcode-addons.com/wp-content/uploads/2019/06/oxi-food-9-1.jpeg',
                        ],
                    ...
                    'sa_el_insert_food_name' => [
                        ...
                        'default' => 'Price Tag',
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-style-3 .oa-fm-3-no-style-{{KEY}} .oxi-addonsFM-TH-heading' => '',
                        ],
                    ],
                    'sa_el_insert_category_name' => [
                        ...
                        'default' => 'Hot Food',
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-style-3 .oa-fm-3-no-style-{{KEY}} .oxi-addonsFM-TH-category' => '',
                        ],
                    ],
                    'sa_el_insert_food_info' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-style-3 .oa-fm-3-no-style-{{KEY}} .oxi-addonsFM-TH-info' => '',
                        ],
                    ],
                    'sa_el_insert_price' => [
                        ...
                        'default' => '27',
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-style-3 .oa-fm-3-no-style-{{KEY}} .oxi-addonsFM-TH-price' => '',
                        ],
                    ],
                    'sa_el_price_link' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-content-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-images .oxi-addonsFM-img' => 'height:{{SIZE}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-images .oxi-addonsFM-img' => 'width:{{SIZE}}{{UNIT}};'
                ],
            ]
        );
        $this->add_group_control(
            'sa-fm-box-image-border',
            $this->style,
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-images .oxi-addonsFM-img' => ''
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-images .oxi-addonsFM-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-images .oxi-addonsFM-img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            'sa_icon_box_heading_text_align',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-style-3 .oxi-addonsFM-TH-category' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section();
