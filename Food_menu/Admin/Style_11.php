...
//         start
        ...
        // hover side
        $this->add_group_control(
                'sa-fm-box-content-side-background', $this->style, [
            'type' => Controls::BACKGROUND,
            'loader' => true,
            'selector' => [
                '{{WRAPPER}} .sa_fm_template_11 .oxi-addons-box-food-content-area' => ''
            ],
                ]
        );
        $this->add_group_control(
                'oa-sa-fm-box-main-border', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-fm-fm-box-main-border-radius', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-box-main-box-shadow', $this->style, [
        ...
        $this->add_responsive_control(
                'sa_fm_box_main_padding', $this->style, [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_fm_template_11 .sa_fm_box_outer' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
                'oa-sa-fm-box-header-font-color', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-box-header-typhography', $this->style, [
        ...
        $this->add_group_control(
                'sa-fm-box-header-text-shadow', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-fm-box-header-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_control(
                'oa-sa-fm-box-descriptions-font-color', $this->style, [
            'label' => __('Font Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-descriptions-typhography', $this->style, [
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
        ...
        $this->add_group_control(
                'oa-sa-fm-descriptions-text-shadow', $this->style, [
            'type' => Controls::TEXTSHADOW,
            'selector' => [
                '{{WRAPPER}} .sa_fm_template_11 .oxi-addons-box-food-desc' => ''
            ],
        ...
        $this->add_responsive_control(
                'oa-sa-fm-descriptions-padding', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_control(
                'oa-sa-fm-price-font-color', $this->style, [
            'label' => __('Font Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_control(
                'oa-sa-fm-price-bg-color', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-fm-price-box-width', $this->style, [
            'label' => __('Width', SHORTCODE_ADDOONS),
            'type' => Controls::SLIDER,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_group_control(
                'oa-sa-fm-price-box-border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .sa_fm_template_11 .oxi-addons-foodMenu-price' => ''
            ],
        ...
        $this->add_responsive_control(
                'sa-fm-price-box-border-radius', $this->style, [
            'label' => __('Border Radius', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
