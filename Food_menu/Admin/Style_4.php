    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_el_insert_food_name' => [
                        ...
                        'type' => Controls::TEXT,
                        'default' => 'Indian Biriyani',
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-content-4 .oa-fm-inner-side-div-{{KEY}} .oxi-addonsFM-FO-heading' => '',
                        ],
                    ],
                    'sa_el_insert_food_info' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-content-4 .oa-fm-inner-side-div-{{KEY}} .oxi-addonsFM-FO-info' => '',
                        ],
                    ],
                    'sa_el_insert_price' => [
                        ...
                        'default' => '27',
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-content-4 .oa-fm-inner-side-div-{{KEY}} .oxi-addonsFM-FO-price' => '',
                        ],
                    ],
                    'sa_el_insert_rating_name' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oa-fm-content-4 .oa-fm-inner-side-div-{{KEY}} .oxi-addonsFM-FO-rating' => '',
                        ],
                    ],
                    'sa_el_price_link' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-content-4 .oa-fm-inner-side-div.sa-max-w-auto' => 'max-width:{{SIZE}}{{UNIT}};'
                ],
                'condition' => [
        ...
        $this->add_group_control(
            'sa-fm-background-bg-top',
            $this->style,
            [
                'label' => __('Header Background', SHORTCODE_ADDOONS),
                'type' => Controls::BACKGROUND,
                'selector' => [
                    '{{WRAPPER}} .oa-fm-content-4 .oxi-addonsFM-FO-content-body' => ''
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-content-4 .oxi-addonsFM-FO-content-body' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa-fm-content-4 .oxi-addonsFM-FO-content-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
