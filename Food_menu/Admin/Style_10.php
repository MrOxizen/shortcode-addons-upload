...
class Style_10 extends AdminStyle
{
    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    'sa_el_food_box_image' => [
                        ...
                        'default' => [
                            'type' => 'media-library',
                            'link' => 'https://www.shortcode-addons.com/wp-content/uploads/2019/06/oxi-food-7-2.jpeg',
                        ],
        ...
        $this->add_group_control(
            'oa-sa-fm-border-box-normal-border',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-fm-box-normal-border-radius',
            $this->style,
            [
        ...
        $this->add_group_control(
            'oa-sa-fm-border-box-hover-border',
            $this->style,
            [
                'type' => Controls::BORDER,
                'selector' => [
        ...
        $this->add_responsive_control(
            'sa_fm_box_contents_hover_padding',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-fm-10-heading-heading-padding',
            $this->style,
            [
                'label' => __('Padding', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        $this->start_controls_tab();
        $this->add_control(
            'oa-sa-fm-10-button-normal-color',
            $this->style,
            [
        ...
        $this->add_control(
            'oa-sa-fm-10-button-background-color',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-fm-box-button-border-radius',
            $this->style,
            [
                'label' => __('Border Radius', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        // hover side
        $this->add_control(
            'oa-sa-fm-10-button-hover-color',
            $this->style,
            [
                'label' => __('Color', SHORTCODE_ADDOONS),
                'loader' => true,
        ...
        $this->add_control(
            'oa-sa-fm-10-button-hover-background',
            $this->style,
            [
                'label' => __('Background', SHORTCODE_ADDOONS),
                'oparetor' => 'RGB',
        ...
        $this->add_responsive_control(
            'sa-fm-box-button-hover-border-radius',
            $this->style,
            [
                'label' => __('Border Radius', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        $this->add_group_control(
            'sa-fm-button-animation-temp-10',
            $this->style,
            [
                'type' => Controls::ANIMATION,
            ]
