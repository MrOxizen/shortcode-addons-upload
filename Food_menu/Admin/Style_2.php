    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_el_insert_food_name' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oa_el_fm_template_2 .oa_el_fm_tem_2_inner_{{KEY}} .oxi-addonsFM-ON-heading' => '',
                        ],
                    ],
                    'sa_el_insert_food_desc' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oa_el_fm_template_2 .oa_el_fm_tem_2_inner_{{KEY}} .oxi-addonsFM-ON-info' => '',
                        ],
                    ],
                    'sa_el_insert_price' => [
                    ...
                    'sa_el_insert_food_rating' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oa_el_fm_template_2 .oa_el_fm_tem_2_inner_{{KEY}} .oxi-addonsFM-ON-rating' => '',
                        ],
                    ],
                    'sa_el_price_link' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa_el_fm_template_2 .oxi-addons-admin-edit-list' => '',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oa_el_fm_template_2 .oa_el_fm_tem_2_inner.sa-max-w-auto' => 'max-width:{{SIZE}}{{UNIT}};'
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            'sa_icon_box_inner_side_image_align',
            $this->style,
            [
