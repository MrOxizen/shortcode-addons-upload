...
class Style_2 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi_addons_step_flow_coloum_style2 ' . $this->column_render('sa_step_flow_coloum', $style) . '">
                   
                        <div class="oxi_addons_step_flow_style2" ' . $this->animation_render('sa_sf_animation', $style) . '>
