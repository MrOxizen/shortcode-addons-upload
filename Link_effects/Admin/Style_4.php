...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4' => 'justify-content:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4' => ''
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#d90021',
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4' => 'color:{{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#6219ff',
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4:hover' => 'color:{{VALUE}};',
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4:focus' => 'color:{{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::TEXTSHADOW,
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4:hover' => ''
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4::after' => 'height:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#6219ff',
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style4 .oxi-links-effects-style4::after' => 'background:{{VALUE}};',
            ],
                ]
        );
