...
class Style_9 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style9' => 'justify-content:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style9' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style9 .oxi-links-effects-style9 .sa_link_text' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
         ...
         $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style9 .oxi-links-effects-style9' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->start_controls_tab();
        $this->add_group_control(
                'sa_link_h_text_typho', $this->style, [
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style9 .oxi-links-effects-style9 .sa_link_hover_text' => ''
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#2c36c7',
           'selector' => [
                '{{WRAPPER}} .link-effect-main-style9 .oxi-links-effects-style9 .sa_link_hover_text' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .link-effect-main-style9 .oxi-links-effects-style9 .sa_link_text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .link-effect-main-style9 .oxi-links-effects-style9 .sa_link_hover_text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
