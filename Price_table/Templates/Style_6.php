...
class Style_6 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        foreach ($child as $v) {
            ...
            echo '<div class="oxi-addons-parent-wrapper-style-6 ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ' . $this->column_render('sa_price_table_column', $style) . '">
                   <div class="oxi-addons-button-wrapper-style-6">
                   <div class="oxi-addons-wrapper-style-6" ' . $this->animation_render('sa_product_boxes_animation', $style) . ' >
                    ' . $ribbon . '
                    ...
                    echo  '</div>
                        ...
                        <div class="oxi-addons-button-over">
                            ' . $button . '
                        </div>  
                 </div>';
            if ($admin == 'admin') :
    ...
    public function inline_public_jquery()
    {
        return 'setTimeout(function () {
            oxiequalHeight($("' . $this->WRAPPER . ' .oxi-addons-wrapper-style-6"));
        }, 500)';
    }
    ...
    public function old_render()
    {
       ...
       $price = $button = $title = $ribon = $price_pos = '';
        $css = '';
        if ($stylefiles[10] != '') {
            $price = '<div class="oxi-addons-price-position">
                        <div class="oxi-addons-price-box">
                            <div style="width: 100%; float: left;">
                                <div class="oxi-addons-price">
