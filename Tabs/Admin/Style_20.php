...
class Style_20 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_tabs_h_text' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-header-{{KEY}}' => '',
                    ],
                ],
                'sa_tabs_content' => [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}}  .sa-addons-tabs-main-wrapper-style-20' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20' => ''
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-main-tab-header' => 'justify-content: {{VALUE}};',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-main-tab-header' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-main-tab-header' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header' => '',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header-two' => '',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#46abc2',
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header' => 'color: {{VALUE}};',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header-two' => 'color: {{VALUE}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#ff8c8c',
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header:hover' => 'color: {{VALUE}};',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header-two:hover' => 'color: {{VALUE}};',
            ],
                ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            'default' => '#ff8c8c',
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header.sa-active' => 'color: {{VALUE}};',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header-two.sa-active' => 'color: {{VALUE}};'
            ],
                ]
        );
        $this->add_control(
                'sa_tabs_headding_bor_c_a', $this->style, [
        ...
        $this->add_control(
                'sa_tabs_headding_bor_size_a', $this->style, [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-header-two' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'include' => Controls::ALIGNNORMAL,
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-body' => '',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-body p' => '',
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#858585',
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-body' => 'color: {{VALUE}};',
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-body p' => 'color: {{VALUE}};',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa-addons-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa_tabs_icon' => 'display: {{VALUE}};'
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-20 .sa_tabs_icon .oxi-icons' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
