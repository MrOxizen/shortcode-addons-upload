...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_tabs_h_text' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-4 .sa-header-{{KEY}}' => '',
                    ],
                ],
                'sa_tabs_content' => [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-4 .sa-addons-tabs-main-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-4 .sa-addons-main-tab-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
                'sa_tabs_headding_border_a_position', $this->style, [
        ...
        $this->add_control(
                'sa_tabs_content_line', $this->style, [
        ...
        $this->add_group_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-4 .sa-addons-body p' => '',
            ],
                ]
        );
        $this->add_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-4 .sa-addons-body p' => 'color: {{VALUE}};',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-4 .sa-addons-header .sa_tabs_icon .oxi-icons' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
                'sa_tabs_headding_line_color', $this->style, [
            'label' => __('Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'loader' => TRUE,
            'default' => '#ff5c5c',
        ...
        $this->add_control(
                'sa_tabs_headding_line_w', $this->style, [
            'label' => __('Width', SHORTCODE_ADDOONS),
            'type' => Controls::SLIDER,
            'default' => [
                'unit' => 'px',
        ...
        $this->add_control(
                'sa_tabs_headding_line_h', $this->style, [
        ...
        $this->add_responsive_control(
                'sa_tabs_headding_line_m', $this->style, [
            'label' => __('Margin', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
