    ...
    public function register_controls() {
        ...
        $this->add_group_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-1 .sa-addons-body P' => '',
            ],
                ]
        );
        $this->add_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-1 .sa-addons-body P' => 'color: {{VALUE}};',
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}}  .sa-addons-tabs-main-wrapper-style-1 .sa-addons-header-two .sa_tabs_icon .oxi-icons' => 'font-size: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-1 .sa-addons-header-two .sa_tabs_icon .oxi-icons' => 'color: {{VALUE}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-1 .sa-addons-header-two:hover .sa_tabs_icon .oxi-icons' => 'color: {{VALUE}};',
            ],
                ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-1 .sa-addons-header-two.sa-active .sa_tabs_icon .oxi-icons' => 'color: {{VALUE}};',
            ],
                ]
        );
