    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_tabs_h_text' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-6 .sa-header-{{KEY}}' => '',
                    ],
                ],
                'sa_tabs_content' => [
        ...
        $this->add_group_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-6 .sa-addons-body p' => '',
            ],
                ]
        );
        $this->add_control(
            ...
            'selector' => [
                ...
                '{{WRAPPER}} .sa-addons-tabs-main-wrapper-style-6 .sa-addons-body p' => 'color: {{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
