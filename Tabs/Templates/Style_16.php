...
class Style_16 extends Templates
{
    ...
    public function inline_public_jquery()
    {
        ...
        $jquery .= ' 
            jQuery(".sa-addons-tabs-main-wrapper-style-16 .sa-addons-header:eq(' . $initial . ')").addClass("sa-active");
            jQuery(".sa-addons-tabs-main-wrapper-style-16 .sa-addons-header-two:eq(' . $initial . ')").addClass("sa-active");
            jQuery(".sa-addons-tabs-main-wrapper-style-16 .sa-addons-body:eq(' . $initial . ')").' . $animationIn . '("slow");
