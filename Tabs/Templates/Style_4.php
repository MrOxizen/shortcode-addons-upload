...
class Style_4 extends Templates
{
    ...
    public function inline_public_jquery()
    {
        ...
        $jquery = '';
        $jquery .= ' 
            jQuery(".sa-addons-tabs-main-wrapper-style-4 .sa-addons-header:eq(' . $initial . ')").addClass("sa-active");
            jQuery(".sa-addons-tabs-main-wrapper-style-4 .sa-addons-header-two:eq(' . $initial . ')").addClass("sa-active");
            jQuery(".sa-addons-tabs-main-wrapper-style-4 .sa-addons-body:eq(' . $initial . ')").addClass("active"); 
