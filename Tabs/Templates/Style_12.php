...
class Style_12 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '<div class="' . $this->WRAPPER . ' sa-addons-tabs-main-wrapper-style-12" ' . $this->animation_render('sa_tabs_tab_anim', $style) . '>
    ...
    public function inline_public_jquery() {
        ...
        $jquery .= ' 
            jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-header:eq(' . $initial . ')").addClass("sa-active");
            jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-header-two:eq(' . $initial . ')").addClass("sa-active");
            jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-body:eq(' . $initial . ')").' . $animationIn . '("slow");
            jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-header").click(function() {
            if (jQuery(this).hasClass("sa-active")) {
                return false
            } else {
                jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-header").removeClass("sa-active");
                jQuery(this).addClass("sa-active");
                jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-body").' . $animationOut . '("slow");
                var activeTab = jQuery(this).attr("ref");
                jQuery(activeTab).' . $animationIn . '("slow"); 
            }
        });
            jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-header-two").click(function() {
            if (jQuery(this).hasClass("sa-active")) {
                return false
            } else {
                jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-header-two").removeClass("sa-active");
                jQuery(this).addClass("sa-active");
                jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12 .sa-addons-body").' . $animationOut . '("slow");
                var activeTab = jQuery(this).attr("ref");
                jQuery(activeTab).' . $animationIn . '("slow");
        ...
        if (array_key_exists('sa_tabs_tab_fix_header', $styledata) && $styledata['sa_tabs_tab_fix_header'] != '0') {
            $jquery .= '    if(fullwidth <= 668){
                            jQuery("html, body").animate({
                                scrollTop: jQuery(".' . $this->WRAPPER . '.sa-addons-tabs-main-wrapper-style-12").offset().top - ' . $styledata['sa_tabs_tab_fix_h_offset'] . '
                            }, 2000);
                        } ';
        }
        $jquery .= '}
