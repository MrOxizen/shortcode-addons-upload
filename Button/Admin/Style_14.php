...
class Style_14 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'default' => 'Button Text',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14 .sa-button-text' => ''
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14 .oxi-icons' => ''
            ],
            'condition' => [
                'sa_btn_icon' => 'yes',
            ],
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14.sa-width-dymanic' => 'max-width:{{SIZE}}{{UNIT}};'
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14' => 'text-align:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14' => ''
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#000000',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'default' => '#000000',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14:hover' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BACKGROUND,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14:hover' => ''
            ],]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14 .oxi-icons' => 'font-size:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            'default' => '#000000',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14 .oxi-icons' => 'color:{{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#000000',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14:hover .oxi-icons' => 'color:{{VALUE}};'
            ],
                ]
        );
         $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-align-btn14 .oxi-button-btn14 .oxi-icons' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
