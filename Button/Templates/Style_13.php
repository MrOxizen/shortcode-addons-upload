...
class Style_13 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '  <div class="oxi-addons-align-btn13">
                         <a ' . $this->animation_render('sa_btn_animation', $style) . ' ' . $this->url_render('sa_btn_link', $style) . ' class="oxi-button-btn13 ' . (array_key_exists('sa_btn_width_choose', $style) && $style['sa_btn_width_choose'] != '0' ? $style['sa_btn_width_choose'] : '') . '" >' . $html . '</a>
                    </div>';
    }
