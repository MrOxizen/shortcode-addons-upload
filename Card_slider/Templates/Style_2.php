...
class Style_2 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo '<div class="oxi-addons__card-slider-style-2 swiper-container-wrap-dots-' . $style['dots_position'] . '">
    ...
    public function inline_public_jquery()
    {
        ...
        $js = '';
        $js = 'var sa_post_carousel = $(".' . $this->WRAPPER . ' .oxi-addons__card-slider-style-2 .oxi-addons__post-carousel-wrap");
