...
class Style_1 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo ' <div class="oxi-addons-mailchimp-style-1">
                <div class="oxi-addons-mailchimp-alert">
                    <div class="oxi-addons-mailchimp-alert-text">
                    </div>
                </div>
                    <form id="oxi-addons-mailchimp-full-content-style-1">';
        ...
        echo ' <div class="oxi-addons-btn-content">
                    <div class="oxi-addons-mailchimp-form">
                        <div class="oxi-addons-mailchimp-form-input-sec">
                            <input type="email"  class="oxi-addons-mailchimp-email" name="oxi-addons-mailchimp-email" id="oxi-addons-mailchimp-email" placeholder="' . $this->text_render($style['sa_mail_chimp_placeholder']) . '"  required="required">
                        </div>
                    </div>
                    ' . $button . '
                    </div>
