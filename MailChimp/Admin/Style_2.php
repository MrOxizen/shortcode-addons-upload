    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2' => ''
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-success-text' => 'color:{{VALUE}};'
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-success-text' => ''
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-alert .oxi-addons-mailchimp-alert-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-alert .oxi-addons-mailchimp-alert-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-alert .oxi-addons-mailchimp-alert-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button' => ''
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-btn-content' => 'flex-direction: {{VALUE}};'
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button' => 'color:{{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button' => 'background-color:{{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button:hover' => 'color:{{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button:hover' => 'background-color:{{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button:hover' => ''
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-mailchimp-style-2 .oxi-addons-mailchimp-button:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->add_group_control(
