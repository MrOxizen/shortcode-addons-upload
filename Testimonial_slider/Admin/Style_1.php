...
class Style_1 extends Swiper_Settings_Admin
{
    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    'sa_testi_slider_profile_picture' => [
                        ...
                        'default' => [
                            'type' => 'media-library',
                            'link' => 'https://www.shortcode-addons.com/wp-content/uploads/2019/06/circle3-1.png',
                        ]
                    ],
                    'sa_testi_slider_profile_name' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oxi-testimonials-style-testinew-{{KEY}} .oxi-testimonials-style-testinew-name' => '',
                        ],
                    ],
                    'sa_testi_slider_profile_designation' => [
                        'label' => __('Designation', SHORTCODE_ADDOONS),
                        'type' => Controls::TEXT,
                        'default' => 'Designation',
                        'placeholder' => 'Designation',
                        'selector' => [
                            '{{WRAPPER}} .oxi-testimonials-style-testinew-{{KEY}} .oxi-testimonials-style-testmonialnew-working' => '',
                        ],
                    ],
                    'sa_testi_slider_profile_company' => [
                        ...
                        'placeholder' => 'Google',
                        'selector' => [
                            '{{WRAPPER}} .oxi-testimonials-style-testinew-{{KEY}} .oxi-testimonials-style-testmonialnew-working a' => '',
                        ],
                    ],
                    ...
                    'sa_testi_slider_profile_rating' => [
                    ...
                    'sa_testi_slider_profile_description' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oxi-testimonials-style-testinew-{{KEY}} .oxi-testimonials-style-testinew-info' => '',
                        ],
                    ]
                ],
        ...
        $this->add_group_control(
            'sa-testimonial-body-background',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-testimonial-body-border-radius',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-testimonials-slider-style-1' => 'padding:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi-testimonials-testinew-padding .oxi-testimonials-style-testinew-image img' => '',
                ]
            ]
        );
        $this->add_control(
            'sa-testimonial-profile-image_alignment',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-testimonial-profile-Information-padding',
            $this->style,
            [
                'label' => __('Padding', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        $this->add_control(
            'sa-testimonial-profile-designation-color',
            $this->style,
            [
                'label' => __('Color', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->add_control(
            'sa-testimonial-ratting_alignment',
            $this->style,
            [
