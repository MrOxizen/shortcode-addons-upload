    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_show' => '',
                ],
            ]
        );
        $this->add_repeater_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_style_1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_show' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu' => 'justify-content: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item' => '',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item.sa_category_fix_width' => 'width: {{SIZE}}{{UNIT}};',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#8d8d8d',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item:hover' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item:hover' => '',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item.sa_active' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item.sa_active' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item.sa_active' => '',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item.sa_active' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_menu_item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        //         ],
        //         'selector' => [
        //             '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_show' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        //         ],
        //     ]
        // );

        // $this->add_responsive_control(
        //     'sa_category_item_padding',
        //     $this->style,
        //     [
        //         'label' => __('Padding', SHORTCODE_ADDOONS),
        //         'type' => Controls::DIMENSIONS,
        ...
        //         ],
        //         'selector' => [
        //             '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_show' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        //         ],
        //     ]
        // );
        // $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'include' => Controls::ALIGNNORMAL,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_text' => ''
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#000000',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_text' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_category_container_style_1 .sa_addons_category_item_text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
