    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#787878',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-bullet-list-area .oxi-addons-list-type-1 .oxi-BL-link:before' => 'color:{{VALUE}};',
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#787878',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-bullet-list-area .oxi-addons-list-type-1 .oxi-BL-link:before' => 'background:{{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#787878',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-bullet-list-area .oxi-addons-list-type-1 .oxi-BL-link:hover:before' => 'color:{{VALUE}};',
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#787878',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-bullet-list-area .oxi-addons-list-type-1 .oxi-BL-link:hover:before' => 'background:{{VALUE}};',
                ]
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-bullet-list-area .oxi-addons-list-type-1 .oxi-BL-link:hover:before' => '',
                ]
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 10,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-bullet-list-area .oxi-addons-list-type-1 .oxi-BL-link:hover' => 'transform: scale({{VALUE}});'
                ],
            ]
        );
