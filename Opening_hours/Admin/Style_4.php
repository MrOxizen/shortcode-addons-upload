...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_oh_icon_color' => [
                    ...
                    'default' => '#000000',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4.oxi-addonsOH-F-wrapper-4-{{KEY}} .oxi-addonsOH-F-icon .oxi-icons' => 'color:{{VALUE}};'
                    ],
                ],
                'sa_oh_icon_bg' => [
                    'type' => Controls::BACKGROUND,
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4.oxi-addonsOH-F-wrapper-4-{{KEY}} .oxi-addonsOH-F-icon .oxi-icons' => ''
                    ],
                ],
                'sa_oh_icon_br' => [
                ...
                'sa_oh_day_color' => [
                    ...
                    'default' => '#ffffff',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4.oxi-addonsOH-F-wrapper-4-{{KEY}} .oxi-addonsOH-F-heading-text' => 'color:{{VALUE}};'
                    ],
                ],
                'sa_oh_end_tab_2' => [
                    'controller' => 'end_controls_tab',
                ...
                'sa_oh_time_color' => [
                    ...
                    'default' => '#ffffff',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4.oxi-addonsOH-F-wrapper-4-{{KEY}} .oxi-addonsOH-F-date' => 'color:{{VALUE}};'
                    ],
                ],
                'sa_oh_end_tab_3' => [
                    'controller' => 'end_controls_tab',
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-row' => 'max-width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-row' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
                'sa_oh_icon_height_width', $this->style, [
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-icon .oxi-icons' => 'height:{{SIZE}}{{UNIT}}; width:{{SIZE}}{{UNIT}}; ',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-icon .oxi-icons' => 'font-size:{{SIZE}}{{UNIT}}; ',
            ],
                ]
        );

        $this->add_responsive_control(
                'sa_oh_icon_br_radius', $this->style, [
            'label' => __('Border radius', SHORTCODE_ADDOONS),
            'separator' => FALSE,
            'type' => Controls::DIMENSIONS,
            'default' => [
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-icon .oxi-icons' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-icon .oxi-icons' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-heading-text' => ''
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-heading-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-date' => ''
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addonsOH-F-wrapper-4 .oxi-addonsOH-F-date' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_tab();
