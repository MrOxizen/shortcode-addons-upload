...
class Style26 extends Public_Render {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            $fronticon = $front_hadding = $back_hadding = $backinfo = $button = $startlink = $endlink = '';
            ...
            if ($value['sa_flip_boxes_heading'] != '') {
                $front_hadding .= '<div class="oxi-addons-flip-box-front-heading">
            ...
            } else if ($this->url_render('sa_flip_boxes_button_link', $value) != '') {
                $startlink .= '<a ' . $this->url_render('sa_flip_boxes_button_link', $value) . '  >';
                $endlink .= '</a>';
            }
            echo '  <div class="oxi-flip-box-col-style-26 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '">
                        <div class="oxi-addons-flip-box-style-26 oxi-addons-flip-box-style-25-' . $key . '"> ' . $startlink . '
