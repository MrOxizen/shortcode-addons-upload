...
class Style25 extends Public_Render {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '  <div class="oxi-flip-box-col-style-25 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '">
                        <div class="oxi-addons-flip-box-style-25 oxi-addons-flip-box-front-section-' . $key . '">
                            '.$startlink.'
