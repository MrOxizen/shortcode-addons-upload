...
class Style_6 extends Templates
{
    ...
    public function inline_public_jquery()
    {
        ...
        $js = '$(".' .  $this->WRAPPER . ' .oxi-addons-mailchimp-form-data").submit(function (e) {
                    ...
                    var rawdata = $(".' .  $this->WRAPPER . ' #oxi-addons-mailchimp-form-style-6").serialize();
    ...
    {
        $button  = $email_placeholder = $heading =  '';
        if (array_key_exists('sa_mail_chimp_button_text', $style) && $style['sa_mail_chimp_button_text'] != '') {
            $button = '<div class="oxi-addons-mailchimp-button-section"> 
                        <button type="submit" class="oxi-addons-mailchimp-button" data-class="SHORTCODE_ADDONS_UPLOAD\Mailchimp\Ajax\Style_6" data-function="ajax_loader" > 
        ...
        echo ' <div class="oxi-addons-mailchimp-style-6"> 
                ...
                ' . $heading . '
                <form  class="oxi-addons-mailchimp-form-data"  id="oxi-addons-mailchimp-form-style-6" method="post">';
