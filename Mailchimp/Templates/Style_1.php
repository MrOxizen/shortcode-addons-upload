...
class Style_1 extends Templates
{
    ...
    public function inline_public_jquery()
    {
        ...
        $js = '$(".' .  $this->WRAPPER . ' .oxi-addons-mailchimp-form-data").submit(function (e) {
                    ...
                    var rawdata = $(".' .  $this->WRAPPER . ' #oxi-addons-mailchimp-form-style-1").serialize();
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo ' <div class="oxi-addons-mailchimp-style-1"> 
                ...
                <form  class="oxi-addons-mailchimp-form-data"  id="oxi-addons-mailchimp-form-style-1" method="post">';
