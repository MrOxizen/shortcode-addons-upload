(window || this).bubbleText = function(ctrl) {
    ...
    // get element
    var $element = jQuery(ctrl.element);
    var dom = $element[0];
    ...
    var spaceWidth = jQuery('<span>. .</span>').appendTo($element).css(spanCSS);
    ...
    function mapString(string) {
        ...
        for (var i = 0, l = string.length; i < l; i++) {
            ...
            array[i] = {
                char: char,
                html: jQuery('<span class="span-bubble-text">' + char + '</span>')
                    .appendTo($element),
            };
            if (char === ' ') {
    ...
    ctrl.restart = function() {
        ...
        jQuery.extend(ctrl, bubbleText(ctrl));
    };
