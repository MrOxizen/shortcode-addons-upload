...
class Style_7 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('jquery-saanimatedtext-css', SA_ADDONS_UPLOAD_URL . '/Animated_text/File/animate.css', true, SA_ADDONS_PLUGIN_VERSION);
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '<div class="oxi-addons-wrapper-style-7 oxi-addons-wrapper-' . $id . '">
                         <div class="oxi-addons-tlt">
                            <ul class="texts" style="display:none"> ';

                                foreach ($styledata['sa_animated_text_data'] as $stylefi) {
                                    if ($stylefi['sa_animated_text_title'] != '') {
                                        $serialize = explode('{{}}', $this->text_render($stylefi['sa_animated_text_title']));
    ...
    public function public_jquery() {
        $this->JSHANDLE = 'jquery-fittext-js';
    ...
    public function inline_public_jquery() {
        ...
        $jquery .= '
            jQuery(function (){   
                ...
                $form.find("[data-key=\'effect\'][data-type=\'in\']").val("'.$styledata['oxi-addons-select-in-animation'].'");
                $form.find("[data-key=\'effect\'][data-type=\'out\']").val("'.$styledata['oxi-addons-select-out-animation'].'"); 
