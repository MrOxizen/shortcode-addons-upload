...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddInfoBanner-nonce')) {
        ...
        $data = '' . OxiAddonsADMHelpItemPerRowsSanitize('OxiAddIconBoxes-par-rows') . ''
                ...
                . 'OxiAddInfo-icon-hover-color|' . sanitize_hex_color($_POST['OxiAddInfo-icon-hover-color']) . '|'
                . '' . OxiAddonsADMHelpBorderSanitize('OxiAddInfo-icon-border-hover-color') . '|'
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddInfo-icon-hover-border-radius') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddInfo-icon-hover-border-S') . ''
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfo-box-icon-BG', $styledata[157], '', 'Icon Background Color', 'Select Your Icon Background Color', 'true', ' .oxi-add-info-box' . $oxiid . ' .oxi-info-icon-icons', 'background');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfo-box-icon-weight', $styledata[45], $styledata[44], $styledata[45], 1, 'Width & Height', 'Set your icon width', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-icon .oxi-icons', 'height');
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfobox-icon-BG-hover-color', $styledata[313], 'rgba', 'Icon background Hover color', 'Set your icon background hover Color', '','.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons','background');
                                            echo OxiAddonsADMhelpBorder('OxiAddInfo-icon-border-hover-color', 317, $styledata, '', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons','border-style');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-icon-hover-border-radius', 321, $styledata, 1, 'Icon Hover Border Radius', 'Set Your icon hover Border Radius', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons', 'border-radius');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-icon-hover-border-S', 337, $styledata, 1, 'Border', 'Set icon hover border','true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons', 'border-width');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfo-icon-hover-color', $styledata[315], '', 'Icon Hover Color', 'Set icon hover color', 'true','.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons','color');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo OxiAddonsADMhelpBorder('OxiAddInfo-link-border', 217, $styledata, '', '.oxi-add-info-box' . $oxiid . ' .oxi-info-link-text','border-style');
                                            ...
                                            echo oxi_addons_adm_help_Text_Align('OxiAddInfo-button-al', $styledata[381], 'Button Align', 'Set Your Button Align', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-link', 'text_align');
                                            ?>
                                        </div>    
                                        <div class="oxi-head">
...
<?php echo oxi_info_boxes_style_6_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
