...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddInfoBanner-nonce')) {
        ...
        $data = '' . OxiAddonsADMHelpItemPerRowsSanitize('OxiAddIconBoxes-par-rows') . ''
                ...
                . 'OxiAddInfo-Button-position |' . sanitize_text_field($_POST['OxiAddInfo-Button-position']).'|'
                . '|||||||||';
        ...
        <div class="oxi-addons-row">
                                ...
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfo-box-icon-weight', $styledata[45], $styledata[44], $styledata[46], 1, 'Width & Height', 'Set your icon width', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-icon .oxi-icons', 'height');
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiAddInfo-link-text-size', $styledata[203], $styledata[204], $styledata[205], 1, 'TExt size', 'Set your link text Size', '', '.oxi-add-info-box' . $oxiid . ' .oxi-info-link-text') ;
                                        ...
                                        echo oxi_addons_adm_help_Text_Align('OxiAddInfo-Button-position', $styledata[271], 'Button Position', 'Set Your button position', '');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAddInfo-link-border-S',221 , $styledata, 1, 'Border', 'set Info box border', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body', 'border-width');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddInfo-link-border-radius', 237, $styledata, 1, 'Border Radius', 'Set Your icon Border Radius', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body', 'border-radius');
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_boxes_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo oxi_addons_adm_help_textbox('OxiAddInfoBanner-i-class', $listitemdata[5], 'Icon Class', 'Set your Icon Class','.oxi-add-info-box' . $oxiid . ' .oxi-info-body');
