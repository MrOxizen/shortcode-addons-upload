                ...
                <form method="post" id="oxi-addons-form-submit">
                    <div class="oxi-addons-style-settings">
                            ...
                            <div class="oxi-addons-tabs-content-tabs">
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiAddInfo-box-animation', 125, $styledata, 'true', '.oxi-add-info-box-' . $oxiid . '-padding');
                                            ?>
                                        </div>
                                    </div>  
                                </div>
                                <div class="oxi-addons-col-6"> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfo-box-icon-hover-color', $styledata[45], '', 'Icon Hover Color', 'Select Your Icon Hover Color', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-body:hover .oxi-info-icon-icons', 'color');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfo-box-icon-weight', $styledata[47], $styledata[48], $styledata[49], 1, 'Width & Height', 'Set your icon width', 'false', '.oxi-add-info-box' . $oxiid . ' .oxi-info-icon .oxi-icons', 'width');
                                            echo oxi_addons_adm_help_Justify_Align('OxiAddInfo-box-icon-position', $styledata[51], 'Text-align', 'Select Your Icon Postion', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-icon', 'justify-content');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-box-icon-padding', 53, $styledata, 1, 'Icon Padding', 'Set icon Padding', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-icon', 'padding');
                                            ?>
                                        </div>                                        
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfo-box-heading-size', $styledata[69], $styledata[70], $styledata[71], 1, 'Font Size', 'Select Your Heading Font Size', '', '.oxi-add-info-box' . $oxiid . ' .oxi-info-title', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfo-box-heading-color', $styledata[73], '', 'Color', 'Select Your Heading Color', 'false', '.oxi-add-info-box' . $oxiid . ' .oxi-info-title', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddInfo-box-heading', 75, $styledata, 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-title');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-box-heading-padding', 81, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-title', 'padding');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddInfo-box-content-size', $styledata[97], $styledata[98], $styledata[99], 1, 'Font Size', 'Select Your Content Font Size', '', '.oxi-add-info-box' . $oxiid . ' .oxi-info-contetn', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddInfo-box-content-color', $styledata[101], '', 'Text Color', 'Select Your Content Color', 'false', '.oxi-add-info-box' . $oxiid . ' .oxi-info-contetn', 'color');
                                            echo OxiAddonsADMHelpFontSettings('OxiAddInfo-box-content', 103, $styledata, 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-contetn');
                                            echo oxi_addons_adm_help_padding_margin('OxiAddInfo-box-content-padding', 109, $styledata, 1, 'Padding', 'Set Your Content Padding', 'true', '.oxi-add-info-box' . $oxiid . ' .oxi-info-contetn', 'padding');
                                            ?>
                                        </div>
                                    </div>                                  
                                </div>
                        ...
                        <div class="oxi-addons-setting-save">
                            ...
                            <input type="hidden"  id="oxi-addons-preview-BG" name="oxi-addons-preview-BG" value="<?php echo $styledata[129]; ?>">
            ...
            <div class="oxi-addons-style-left-preview">
                <div class="oxi-addons-style-left-preview-heading">
                    ...
                    <div class="oxi-addons-style-left-preview-heading-right">
                        <?php echo oxi_addons_adm_help_preview_color($styledata[129]); ?>
                    </div>
                </div>
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_info_boxes_style_1_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
