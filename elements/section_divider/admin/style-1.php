                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo oxi_addons_adm_help_number('OASection-width', $styledata[13], 1, 'Width', 'Set your Section Width based on percentise', '.oxi-addons-divider-' . $oxiid . '', 'width');
                                        echo oxi_addons_adm_help_number_dtm('OASection-height', $styledata[15], $styledata[16], $styledata[17], 1, 'Height', 'Your Divider Height', '.oxi-addons-divider-' . $oxiid . '', 'height');
                                        echo OxiAddonsADMHelpNoJquery(
                                            array(
