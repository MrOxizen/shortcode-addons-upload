...
function oxi_content_boxes_style_7_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    ...
    foreach ($listdata as $value) {
        ...
        echo '<div class="' . OxiAddonsItemRows($styledata, 251) . '  ' . OxiAddonsAdminDefine($user) . '">';
