        ...
        <div class="oxi-addons-row">
                            ...
                            <div class="oxi-addons-tabs-content-tabs" id="oxi-tabs-id-1">
                                <div class="oxi-addons-col-6">
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo OxiAddonsADMHelpItemPerRows('OxiAddIconBoxes-rows', $styledata, 133, 'false', '.oxi-addons-admin-edit-list');
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-padding', 15, $styledata, 1, 'Padding', 'Set Your Content Boxes Paddins', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-' . $oxiid . '-content', 'padding');
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            ...
                                            echo oxi_addons_adm_help_padding_margin('OxiAddCB-heading-padding', 71, $styledata, 1, 'Padding', 'Set Your Heading Padding', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-heading');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="oxi-addons-col-6">
                                    ...
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-BG-color', $styledata[121], 'rgba', 'Background Color', 'Select Your Background Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon', 'background');
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-I-height', $styledata[117], $styledata[118], $styledata[119], 1, 'Height', 'Select Your Icon Height', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-addons-content-boxes-icon', 'height');
                                            ?>
                                        </div>
                                    </div> 
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_number_dtm('OxiAddCB-i-size', $styledata[123], $styledata[124], $styledata[125], 1, 'Size', 'Select Your Icon Size', 'true', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-icons', 'font-size');
                                            echo oxi_addons_adm_help_MiniColor('OxiAddCB-i-color', $styledata[127], '', 'Color', 'Select Your Icon Color', 'false', '.oxi-addons-content-boxes-' . $oxiid . ' .oxi-icons', 'color');
                                            ?>
                                        </div>
                                    </div>       
                                    <div class="oxi-addons-content-div">
                                        ...
                                        <div class="oxi-addons-content-div-body">
                                            <?php
                                            echo oxi_addons_adm_help_Animation('OxiAddCB-i-animation', 129, $styledata, 'true', '.oxi-addons-content-boxes-icon-data');
                                            ?>
                                        </div>
                                    </div>       
                                </div> 
            ...
            <div class="oxi-addons-style-left-preview">
                ...
                <div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
                    <?php echo oxi_content_boxes_style_5_shortcode($style, $listdata, 'admin') ?>
                </div>
            </div>
        </div>
    </div>
