...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
	if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
		...
		$data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
				...
				. '||'
				. '||'
				. OxiAddonsADMHelpFontSettingsSanitize('oxi-BL-number-font')
		...
		<div class="oxi-addons-row">
						...
						<div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-1">
							<div class="oxi-addons-col-6">
								...
								<div class="oxi-addons-content-div">
									...
									<div class="oxi-addons-content-div-body">
										<?php
										echo oxi_addons_adm_help_number_double_dtm('oxi-BL-number-line-width', $styledata[179], $styledata[180], $styledata[181], 'oxi-BL-number-line-height', $styledata[183], $styledata[184], $styledata[185], 1, 'Number Width & Height', 'Set Your List Number Width And Height', 'false');	
										echo oxi_addons_adm_help_number_dtm('oxi-BL-number-font-size', $styledata[43], $styledata[44], $styledata[45], 1, 'Font Size', 'Set Your List Number Font Size', 'false', '.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a:before', 'font-size');
										echo oxi_addons_adm_help_MiniColor('oxi-BL-number-color', $styledata[73], '', 'Color', 'Set Your List Number Color', 'false', '	.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a.oxi-BL-link:before', 'color');
										echo oxi_addons_adm_help_MiniColor('oxi-BL-number-bg-color', $styledata[75], 'rgba', 'Background Color', 'Set Your List Number Background Color', 'false', '	.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a.oxi-BL-link:before', 'background');
										echo oxi_addons_adm_help_padding_margin('oxi-BL-number-border-width', 131, $styledata, 1, 'Border', 'Set Border for Your List Number', 'true', '.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a:before', 'border-width');
										...
										echo OxiAddonsADMHelpFontSettings('oxi-BL-number-font', 51, $styledata, 'true', '.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a:before');
			...
			<div class="oxi-addons-style-left-preview">
				...
				<div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
					<?php echo oxi_bullet_list_style_2_shortcode($style, $listdata, 'admin'); ?>
				</div>
			</div>
		</div>
	</div>
