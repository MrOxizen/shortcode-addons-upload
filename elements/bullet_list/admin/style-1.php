...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
	if (!wp_verify_nonce($nonce, 'oxi-addons-button-nonce')) {
		...
		$data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
				...
				. oxi_addons_adm_help_padding_margin_senitize('oxi-BL-number-padding')
		...
		<div class="oxi-addons-row">
							...
							<div class="oxi-addons-col-6">
								...
								<div class="oxi-addons-content-div">
									...
									<div class="oxi-addons-content-div-body">
										...
										echo oxi_addons_adm_help_MiniColor('oxi-BL-number-color', $styledata[73], '', 'Color', 'Set Your List Number Color', 'false', '.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a:before', 'color');
										...
										echo oxi_addons_adm_help_padding_margin('oxi-BL-number-padding', 57, $styledata, 1, 'Padding', 'Set Your List Number Padding', 'true', '.oxi-addons-bullet-list-' . $oxiid . ' .oxi-addons-list-type-1 a:before', 'padding');
										?>
									</div>
									<div class="oxi-head">
										List Number Hover
			...
			<div class="oxi-addons-style-left-preview">
				...
				<div class="oxi-addons-preview-data" id="oxi-addons-preview-data">
					<?php echo oxi_bullet_list_style_1_shortcode($style, $listdata, 'admin'); ?>
				</div>
			</div>
		</div>
	</div>
