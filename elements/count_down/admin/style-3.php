...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'OxiAddDropCaps-nonce')) {
        ...
        $data = 'oxi-addons-preview-BG |' . sanitize_text_field($_POST['oxi-addons-preview-BG']) . '|'
                ...
                . '' . oxi_addons_adm_help_number_dtm_senitize('OxiADDCD-radius') . ''
                . '' . OxiAddonsBGImageSanitize('OxiADDCD-bg') . ''
                . '' . oxi_addons_adm_help_padding_margin_senitize('OxiAddCD-border') . ''
                        ...
                        <div class="oxi-addons-tabs-content-tabs" id="oxi-addons-tabs-id-1">
                            <div class="oxi-addons-col-6">
                                ...
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiADDCD-width', $styledata[95], $styledata[96], $styledata[97], 1, 'Width Height', 'Set Your Count Down Width and Height', 'true', '');
                                        echo OxiAddonsADMHelpBGImage('OxiADDCD-bg', $styledata, 103, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-mid');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddCD-border', 107, $styledata, 1, 'Border', 'Set Your Size Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-mid', 'border-width');
                                        echo OxiAddonsADMhelpBorder('OxiAddCD-border', 123, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-mid');
                                        echo oxi_addons_adm_help_number_dtm('OxiADDCD-radius', $styledata[99], $styledata[100], $styledata[101], 1, 'Border Radius', 'Set Your Count Down Border Radius Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-mid', 'border-radius');
                                        echo oxi_addons_adm_help_padding_margin('OxiADDCD-padding', 7, $styledata, 1, 'Padding', 'Set Your Count Down Size Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-section', 'padding');
                                        echo oxi_addons_adm_help_padding_margin('OxiADDCD-margin', 23, $styledata, 1, 'Margin', 'Set Your Count Down Size Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-section', 'margin');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiADDCD-N-font-size', $styledata[67], $styledata[68], $styledata[69], 1, 'Font Size', 'Set Your Count Down Number Font Size', '', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-amount', 'font-size');
                                        echo oxi_addons_adm_help_MiniColor('OxiADDCD-N-color', $styledata[71], '', 'Color', 'Select Your Heading Color', '', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-amount', 'color');
                                        echo OxiAddonsADMHelpFontSettings('OxiAddCD-N', 73, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-amount');
                                        echo oxi_addons_adm_help_padding_margin('OxiAddCD-N-padding', 79, $styledata, 1, 'Padding', 'Set Your Count Down Size Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-amount', 'padding');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        <?php
                                        echo oxi_addons_adm_help_number_dtm('OxiAddCD-T-font-size', $styledata[135], $styledata[136], $styledata[137], 1, 'Font Size', 'Set Your Count Down Heading Font Size', '', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-period', 'font-size');
                                        ...
                                        echo oxi_addons_adm_help_padding_margin('OxiAddCD-T-padding', 147, $styledata, 1, 'Padding', 'Set Your Count Down Size Top Bottom and Left Right', 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-countdown-period', 'padding');
                                        ?>
                                    </div>
                                </div>
                                <div class="oxi-addons-content-div">
                            ...
                            <div class="oxi-addons-col-6">
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo OxiAddonsADMHelpBGImage('OxiADDCD-D-N-bg', $styledata, 209, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-days .oxi-countdown-mid');
                                        echo OxiAddonsADMhelpBorder('OxiAddCD-D-N-border', 213, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-days .oxi-countdown-mid');
                                        ?>
                                    </div>                                               
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo OxiAddonsADMHelpBGImage('OxiADDCD-H-N-bg', $styledata, 255, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-hours .oxi-countdown-mid');
                                        echo OxiAddonsADMhelpBorder('OxiAddCD-H-N-border', 259, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-hours .oxi-countdown-mid');
                                        ?>
                                    </div>                                               
                                </div>
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo OxiAddonsADMHelpBGImage('OxiADDCD-M-N-bg', $styledata, 301, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-minutes .oxi-countdown-mid');
                                        echo OxiAddonsADMhelpBorder('OxiAddCD-M-N-border', 305, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-minutes .oxi-countdown-mid');
                                        ?>
                                    </div>                                               
                                </div>  
                                <div class="oxi-addons-content-div">
                                    ...
                                    <div class="oxi-addons-content-div-body">
                                        ...
                                        echo OxiAddonsADMHelpBGImage('OxiADDCD-S-N-bg', $styledata, 347, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-seconds .oxi-countdown-mid');
                                        echo OxiAddonsADMhelpBorder('OxiAddCD-S-N-border', 351, $styledata, 'true', '.oxi-addons-counter-' . $oxiid . ' .oxi-addons-counter-seconds .oxi-countdown-mid');
                                        ?>
                                    </div>                                               
                                </div>
