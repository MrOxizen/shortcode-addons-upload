...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .map-position-style4' => 'max-width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .map-position-style4' => 'height:{{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .map-style4' => 'height:{{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .pan-style4' => 'height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .map-position-style4' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
...
//            ],
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_add_gmap_location_info_body-style4' => ''
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'default' => '#dddddd',
            'selector' => [
                '{{WRAPPER}} .oxi_add_gmap_location_info_body-style4' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_add_gmap_location_info-style4' => 'width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_add_gmap_location_info-style4' => 'height:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
