    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_carousel_type' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_unique_{{KEY}}' => '',
                        ],
                    ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1' => 'padding: 0{{UNIT}} {{RIGHT}}{{UNIT}} 0{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-stage-outer' => 'padding: {{TOP}}{{UNIT}} 0{{UNIT}} {{BOTTOM}}{{UNIT}} 0{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-stage' => 'align-items: {{VALUE}};'
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .sa_addons_carousel_item_text' => ''
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .sa_addons_carousel_item_text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1' => '',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_top_left .oxi-owl-dots' => 'left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_top_right .oxi-owl-dots' => 'right: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_bottom_left .oxi-owl-dots' => 'left: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_bottom_right .oxi-owl-dots' => 'right: {{SIZE}}{{UNIT}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_top_left .oxi-owl-dots' => 'top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_top_midd .oxi-owl-dots' => 'top: {{SIZE}}{{UNIT}}; left: 50%; transform:translateX(-50%);',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_top_right .oxi-owl-dots' => 'top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_bottom_left .oxi-owl-dots' => 'bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_bottom_midd .oxi-owl-dots' => 'bottom: {{SIZE}}{{UNIT}}; left: 50%; transform:translateX(-50%);',
                    '{{WRAPPER}} .sa_addons_carousel_style_1.sa_carousel_dot_bottom_right .oxi-owl-dots' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => '',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot:hover span' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot:hover span' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot:hover span' => 'transform: scale({{SIZE}}); -webkit-transform: scale({{SIZE}}); -moz-transform: scale({{SIZE}}); -ms-transform: scale({{SIZE}}); -o-transform: scale({{SIZE}});',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot.active span' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot.active span' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot.active span' => 'transform: scale({{SIZE}}); -webkit-transform: scale({{SIZE}}); -moz-transform: scale({{SIZE}}); -ms-transform: scale({{SIZE}}); -o-transform: scale({{SIZE}});',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_carousel_style_1 .oxi-owl-dot span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
