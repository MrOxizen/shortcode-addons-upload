...
class Style_4 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo '<div class="sa_addons_carousel_style_4 sa_addons_carousel_style_4_' . $oxiid . '  ' . $styledata['sa_carousel_dot_posi'] . '  ' . $styledata['sa_carousel_dot_view'] . '  ' . $styledata['sa_carousel_nav_style_posi'] . '  ' . $styledata['sa_carousel_nav_style'] . '">';
        ...
        if ($styledata['sa_carousel_cen_mod_on_off'] == 'true') {
            $this->inline_css .= '.' . $this->WRAPPER . ' .sa_addons_carousel_style_4 .oxi-owl-item, 
                            ' . $this->WRAPPER . ' .sa_addons_carousel_style_4 .oxi-owl-item{
                opacity:0.8;
                transform:scale(0.94);
            }
            .' . $this->WRAPPER . ' .sa_addons_carousel_style_4 .oxi-owl-item.active.center{
                opacity:1;
                transform:scale(1);
            }
         ';
    ...
    public function inline_public_jquery()
    {
        ...
        $jquery = 'jQuery(".sa_addons_carousel_style_4_' . $oxiid . '").OxiAddowlCarousel({
    ...
    public function old_render()
    {
        ...
        $jquery = 'jQuery(".oxi-addons-carousel-' . $oxiid . '").OxiAddowlCarousel({
                    ...
                    responsive: {
                        0: {
                            merge:false,
                            items: ' . $this->OxiAddonscolReplacecarousel4($styledata[5]) . '
                        },
                        668: {
                            merge:false,
                            items: ' . $this->OxiAddonscolReplacecarousel4($styledata[4]) . '
                        },
                        1000: {
                            merge:' . $styledata[233] . ',
                            items: ' . $this->OxiAddonscolReplacecarousel4($styledata[3]) . '
                        }
                    }
                });
               ' . $eualdata . '';
