...
class Style_1 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        if ($styledata['sa_carousel_cen_mod_on_off'] == 'true') {
            $this->inline_css .= '.' . $this->WRAPPER . ' .sa_addons_carousel_style_1 .oxi-owl-item, 
                            ' . $this->WRAPPER . ' .sa_addons_carousel_style_1 .oxi-owl-item{
                opacity:0.8;
                transform:scale(0.94);
            }
            .' . $this->WRAPPER . ' .sa_addons_carousel_style_1 .oxi-owl-item.active.center{
                opacity:1;
                transform:scale(1);
            }
         ';
