...
class Style_2 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo '<div class="sa_addons_carousel_style_2 sa_addons_carousel_style_2_' . $oxiid . '  ' . $styledata['sa_carousel_dot_posi'] . '  ' . $styledata['sa_carousel_dot_view'] . '  ' . $styledata['sa_carousel_nav_style_posi'] . '  ' . $styledata['sa_carousel_nav_style'] . '">';
        ...
        if ($styledata['sa_carousel_cen_mod_on_off'] == 'true') {
            ...
            .' . $this->WRAPPER . ' .sa_addons_carousel_style_2 .oxi-owl-item.active.center{
                opacity:1;
                transform:scale(1);
            }
         ';
    ...
    public function old_render()
    {
        ...
        if ($styledata[121] == 'icon') {
            ...
            $eualdata = ' oxiequalHeight(jQuery(".oxi-addons-carousel-' . $oxiid . ' .oxi-owl-nav .oxi-icons"))';
        } else {
