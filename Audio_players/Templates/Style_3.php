...
class Style_3 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo '<div class="sa_addons_ap_container_style_3 ' . $show_volume_handle . '  ' . $show_progress_handle . '">
            ...
            ';
        $this->inline_css .= '.' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-replay button::after, .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-play button::after {
            content: "\\' . $this->text_render($this->style['sa_ap_audio_ply_icon'] != '' ? $this->style['sa_ap_audio_ply_icon'] : '') . '" !important;
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-pause button::after {
            content: "\\' . $this->text_render($this->style['sa_ap_audio_pau_icon'] != '' ? $this->style['sa_ap_audio_pau_icon'] : '') . '" !important;
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-unmute button::after {
            content: "\\' . $this->text_render($this->style['sa_ap_audio_s_v_icon'] != '' ? $this->style['sa_ap_audio_s_v_icon'] : '') . '" !important;
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-mute button::after {
            content: "\\' . $this->text_render($this->style['sa_ap_audio_p_v_icon'] != '' ? $this->style['sa_ap_audio_p_v_icon'] : '') . '" !important;
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-playpause-button>button {
            content: "\\' . $this->text_render($this->style['sa_ap_audio_p_v_icon'] != '' ? $this->style['sa_ap_audio_p_v_icon'] : '') . '" !important;
        }
        .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 .mejs-volume-button {
    ...
    public function inline_public_jquery()
    {
        ...
        if ((array_key_exists('sa_ap_audio_play_pause', $style) && $style['sa_ap_audio_play_pause'] != '0') || (array_key_exists('sa_ap_audio_time', $style) && $style['sa_ap_audio_time'] != '0') || (array_key_exists('sa_ap_audio_volume', $style) && $style['sa_ap_audio_volume'] != '0') || (array_key_exists('sa_ap_audio_progress', $style) && $style['sa_ap_audio_progress'] != '0')) {
            $jquery .= '  jQuery(" .' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 #mediaplayer").mediaelementplayer({
                    features: [';
            ...
            $jquery = '.' . $this->WRAPPER . ' .sa_addons_ap_container_style_3 #mediaplayer{display: none}';
        }
        return $jquery;
    }
    ...
    public function old_render()
    {
       ...
       success: function (mediaElement, domObject) {
        ...
        .oxi-addons-wrapper-' . $oxiid . ' .mejs-volume-button{
            ...
            padding-left: 5px;
            position: absolute;
            right: ' . ($styledata[294] + $styledata[342]) . 'px;
            bottom: ' . $styledata[298] . 'px; 
        }
        .oxi-addons-wrapper-' . $oxiid . ' .mejs-horizontal-volume-slider { 
            width: ' . ($styledata[342]) . 'px; 
            position: absolute !important;
            right: ' . $styledata[294] . 'px;
            bottom: ' . $styledata[298] . 'px;
        }
        ...
        @media only screen and (min-width : 669px) and (max-width : 993px){ 
            ...
            .oxi-addons-wrapper-' . $oxiid . ' .mejs-volume-button{ 
                right: ' . ($styledata[295] + $styledata[343]) . 'px !important;
                bottom: ' . $styledata[299] . 'px  !important; 
            }
            .oxi-addons-wrapper-' . $oxiid . '  .mejs-time-float-current{
                width: ' . $styledata[265] . 'px;
                height: ' . $styledata[269] . 'px;  
