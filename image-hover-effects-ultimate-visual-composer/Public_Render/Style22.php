...
class Style22 extends Public_Render {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            echo '  <div class="oxi-flip-box-col-style-22 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '">
                        <div class="oxi-addons-flip-box-style-22">
                            ' . $bt . '
            ...
            echo ' </div>';
            $this->inline_css .= '.' . $this->WRAPPER . ' .oxi-addons-flip-box-style-22 .oxi-addons-flip-box-front-section-' . $val['id'] . ':before{
