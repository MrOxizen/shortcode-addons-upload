    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $key => $val) {
            ...
            if ($this->text_render($value['sa_flip_boxes_font_description']) != '') {
                $fontinfo .= '<div class="oxi-addons-flip-box-front-info">
            ...
            echo '  <div class="oxi-flip-box-col-style-27 ' . $this->column_render('sa-flip-boxes-col', $style) . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . '">
