...
class Style_1 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            'sa_twitter_display_mode_collection',
            $this->style,
            [
                ...
                'options'   => [
                    ...
                    'grid'     => __('Grid', SHORTCODE_ADDOONS),
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'step'      => '1',
                'condition' => [
                    'sa_twitter_display_mode_collection' => 'grid',
                ]
            ]
        );
        $this->add_control(
            'sa_twitter_height_collection_timeline',
            $this->style,
            [
                ...
                'condition' => [
                    'sa_twitter_display_mode_collection' => 'timeline',
                ]
            ]
        );
        $this->add_control(
            'sa_twitter_theme_collection_timeline',
            $this->style,
            [
        ...
        $this->add_control(
            'sa_twitter_link_color_collection',
            $this->style,
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_twitter_container_style_1' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_twitter_container_style_1' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_twitter_container_style_1 .sa_twitter_main' => '',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_twitter_container_style_1 .sa_twitter_main' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .sa_twitter_container_style_1 .sa_twitter_main iframe' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_twitter_container_style_1 .sa_twitter_main' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_twitter_container_style_1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
