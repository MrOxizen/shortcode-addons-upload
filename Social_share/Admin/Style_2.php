...
class Style_2 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-ss2 .oxi-addons-main-share-circle .oxi-addons-circle' => 'width:{{SIZE}}{{UNIT}}; height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->add_responsive_control(
                'sa_ss_height', $this->style, [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-ss2 .oxi-addons-main-share-circle .oxi-addons-social-icon' => 'font-size:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
       ...
       $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-wrapper-ss2 .oxi-addons-soical' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
