...
class Style_2 extends Templates {
    ...
    public function inline_public_jquery() {
        $js = 'setTimeout(function () { oxiequalHeight(jQuery(".oxi-addons-wrapper-ss2 .oxi-addons-main-share-circle"));}, 1500);';
        return $js;
    }
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($all_data as $key => $value) {
            $icon = $text = '';
            if ($value['sa_ss_icon_icon'] != '') {
                $icon = ' <div class="oxi-addons-main-icon-' . $value['sa_ss_social_media'] . '">
                        ' . $this->font_awesome_render($value['sa_ss_icon_icon']) . '
                        </div>';
            }
            if ($value['sa_ss_text'] != '') {
                $text = '<div class="oxi-addons-text oxi-addons-text-' . $value['sa_ss_social_media'] . '">
                           ' . $this->text_render($value['sa_ss_text']) . '
                        </div>';
            }
            $icons .= '
        ...
        global $wp;
        echo '<div class="oxi-addons-wrapper-ss2">
    ...
    ';
        ...
        wp_add_inline_script('jquery.countdown.min', $js);
    }
