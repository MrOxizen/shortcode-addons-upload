    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER, 
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-4 .member-icon.common' => ''
                ],
                'condition' => [
        ...
        $this->add_group_control(
            'sa_divider_icons_hover_border',
            $this->style,
            [
                'type' => Controls::BORDER, 
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-4 .member-icon.common:hover' => ''
                ],
                'condition' => [
