...
class Style_22 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
                'sa_social_main_bg_color', $this->style, [
            'label' => __('Background', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'oparetor' => 'RGB',
            'default' => '#21b0b8',
            'selector' => [
                '{{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .oxi-team-pic-size-span:before, {{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .oxi-team-pic-size-span:after' => 'background:{{VALUE}}'
            ],
                ]
        );
        ...
        $this->add_control(
                'sa_social_overlay_bg_color', $this->style, [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .member-divider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .member-icon.separately' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .member-icon.separately' => 'border-style: {{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-22 .member-icon.common' => ''
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .member-icon.separately:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-22 .member-icon.separately:hover' => 'border-style: {{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-22 .member-icon.common:hover' => ''
            ],
            'condition' => [
