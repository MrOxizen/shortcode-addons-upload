...
class Style_11 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .oxi-team-show-body-style-11:hover .member-content-absolute' => ''
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
                'sa_team_hover_border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .oxi-team-show-body-style-11:hover .member-photo' => ''
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .member-divider' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .member-icon.separately' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .member-icon.separately' => 'border-style: {{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-11 .member-icon.common' => ''
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .member-icon.separately:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-11 .member-icon.separately:hover' => 'border-style: {{VALUE}};'
                ],
            ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-11 .member-icon.common:hover' => ''
            ],
            'condition' => [
