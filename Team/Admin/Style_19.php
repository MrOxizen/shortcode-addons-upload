    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-parent-wrapper-style-19 .member-divider' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-19 .member-icon' => ''
                ],
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-parent-wrapper-style-19 .member-icon:hover' => ''
                ],
                'condition' => [
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_social_icons_border' => [
                        ...
                        'type' => Controls::BORDER,
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-parent-wrapper-style-19-{{KEY}}  .member-icon' => '',
                        ],
                    ...
                    'sa_social_icons_border_hover' => [
                        ...
                        'type' => Controls::BORDER,
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-parent-wrapper-style-19-{{KEY}}  .member-icon:hover' => '',
                        ],
                        'controller' => 'add_group_control',
                        'conditional' => Controls::OUTSIDE,
                        'condition' => [
