...
class Style_5 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($child as $v) {
            ...
            echo '<div class="oxi-addons-parent-wrapper-style-5 oxi-addons-parent-wrapper-style-5-' . $v['id'] . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ' . $this->column_render('sa_team_column', $style) . '">
                   <div class="oxi-team-show-body-style-5" ' . $this->animation_render('sa_team_animation', $style) . ' >
