...
class Style_6 extends Templates
{
    public function default_render($style, $child, $admin)
    {
        ...
        foreach ($child as $v) {
            ...
            echo '<div class="oxi-addons-parent-wrapper-style-6 oxi-addons-parent-wrapper-style-6-' . $v['id'] . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ' . $this->column_render('sa_team_column', $style) . ' ' .  $style['sa_banner_icon_position'] . ' ">
                   <div class="oxi-team-show-body-style-6" ' . $this->animation_render('sa_team_animation', $style) . ' >
    ...
    public function inline_public_css() {
        ...
        foreach ($childdata as $v) {
            ...
            foreach ($datas as $key => $data) {
                $css .= '.' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-6.oxi-addons-parent-wrapper-style-6-' . $v['id'] . ' .member-icon.member-icon-' . $key . ' .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color'] . ';' : '' ) . '
                            
                            }
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-6.oxi-addons-parent-wrapper-style-6-' . $v['id'] . ' .member-icon.member-icon-' . $key . '{
                        ...
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-6.oxi-addons-parent-wrapper-style-6-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color_hover'] . ';' : '' ) . '
                           }
                           .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-6.oxi-addons-parent-wrapper-style-6-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover{
    ...
    public function old_render()
    {
        ...
        $css .= '.oxi-addons-team-' . $oxiid . '{
                ...
                .oxi-addons-team-' . $oxiid . ' .oxi-team-pic-size img{
                    ...
                    height: 100%;
                    display: block;
                    transition: all ' . $styledata[183] . 's;
                    transform:scale(' . $styledata[179] . ')                
                }
                .oxi-addons-team-' . $oxiid . ':hover .member-photo img{
                    transform:scale(' . $styledata[181] . ')   
                }
                ...
                .oxi-addons-team-' . $oxiid . ' .member-icon{
                    ...
                    margin-top:' . $styledata[155] . 'px;
                    display: flex;
                    align-items:center;
                    justify-content:center;
                    Border-radius:' . OxiAddonsPaddingMarginSanitize($styledata, 243) . ';
                    transform:translateX(' . ($styledata[187] + $styledata[23] + 5) . 'px);    
                }  
                .oxi-addons-team-' . $oxiid . ':hover .member-icon{
                ...
                @media only screen and (min-width : 669px) and (max-width : 993px){
                    ...
                    .oxi-addons-team-' . $oxiid . ' .member-icon{
                        ...
                        margin-top:' . $styledata[156] . 'px;
                        Border-radius:' . OxiAddonsPaddingMarginSanitize($styledata, 244) . ';
                        transform:translateX(' . ($styledata[188] + $styledata[24] + 5) . 'px);    
                    } 
                    .oxi-addons-team-' . $oxiid . ' .member-icon .oxi-icons {
                ...
                @media only screen and (max-width : 668px){ 
                    ...
                    .oxi-addons-team-' . $oxiid . ' .member-icon{
                        ...
                        margin-top:' . $styledata[157] . 'px;
                        Border-radius:' . OxiAddonsPaddingMarginSanitize($styledata, 245) . ';
                        transform:translateX(' . ($styledata[189] + $styledata[25] + 5) . 'px);    
                    } 
                    .oxi-addons-team-' . $oxiid . ' .member-icon .oxi-icons {
