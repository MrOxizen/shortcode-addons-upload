    ...
    public function default_render($style, $child, $admin)
    {
     ...
     public function inline_public_css() {
        ...
        foreach ($childdata as $v) {
            ...
            foreach ($datas as $key => $data) {
                $css .= '.' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-13.oxi-addons-parent-wrapper-style-13-' . $v['id'] . ' .member-icon.member-icon-' . $key . ' .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color'] . ';' : '' ) . '
                            
                            }
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-13.oxi-addons-parent-wrapper-style-13-' . $v['id'] . ' .member-icon.member-icon-' . $key . '{
                        ...
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-13.oxi-addons-parent-wrapper-style-13-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color_hover'] . ';' : '' ) . '
                           }
                           .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-13.oxi-addons-parent-wrapper-style-13-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover{
