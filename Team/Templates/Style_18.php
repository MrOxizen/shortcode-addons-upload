...
class Style_18 extends Templates
{
    public function default_render($style, $child, $admin)
    {
        ...
        foreach ($child as $v) {
            ...
            if (array_key_exists('sa_price_table_para', $value) && $value['sa_price_table_para'] != '') {
                $description = ' 
                <div class="oxi-team-pic-para">
                    <div class="oxi-team-pic-para-data">' . $this->text_render($value['sa_price_table_para']) . '</div>
                </div>';
            }
            ...
            echo '<div class="oxi-addons-parent-wrapper-style-18 oxi-addons-parent-wrapper-style-18-' . $v['id'] . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ' . $this->column_render('sa_team_column', $style) . '">
                   <div class="oxi-team-show-body-style-18" ' . $this->animation_render('sa_team_animation', $style) . ' >
     ...
     public function inline_public_css() {
        ...
        foreach ($childdata as $v) {
            ...
            foreach ($datas as $key => $data) {
                $css .= '.' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-18.oxi-addons-parent-wrapper-style-18-' . $v['id'] . ' .member-icon.member-icon-' . $key . ' .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color'] . ';' : '' ) . '
                            
                            }
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-18.oxi-addons-parent-wrapper-style-18-' . $v['id'] . ' .member-icon.member-icon-' . $key . '{
                        ...
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-18.oxi-addons-parent-wrapper-style-18-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color_hover'] . ';' : '' ) . '
                           }
                           .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-18.oxi-addons-parent-wrapper-style-18-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover{
                        ...
                        <div class="member-photo">
                            <div class="oxi-team-pic-size">
                                <img src="' . OxiAddonsUrlConvert($data[5]) . '" alt="' . OxiAddonsTextConvert($data[1]) . '">
                                    <div class="oxi-team-pic-para">
                                        <div class="oxi-team-pic-para-data">' . OxiAddonsTextConvert($data[9]) . '</div>
                                     </div>
                            </div>
                                ' . $socialdata . '
                            <div class="member-info ">
    ...
    $css .= '.oxi-addons-team-' . $oxiid . '{
            ...
            .oxi-addons-team-' . $oxiid . ' .oxi-team-pic-para{
                position: absolute;
                left: 0;  
                top:0;
                height:100%;                
            ...
            .oxi-addons-team-' . $oxiid . ' .oxi-team-pic-para .oxi-team-pic-para-data{
                position: absolute;
                left: 0; 
                width:100%;
                bottom:0;
            ...
            .oxi-addons-team-' . $oxiid . ':hover .oxi-team-pic-para{
                opacity:1;
            }
