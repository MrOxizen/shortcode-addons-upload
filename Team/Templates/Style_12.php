...
class Style_12 extends Templates
{
    public function default_render($style, $child, $admin)
    {
        ...
        foreach ($child as $v) {
            ...
            echo '<div class="oxi-addons-parent-wrapper-style-12 oxi-addons-parent-wrapper-style-12-' . $v['id'] . ' ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ' . $this->column_render('sa_team_column', $style) . '">
                   <div class="oxi-team-show-body-style-12" ' . $this->animation_render('sa_team_animation', $style) . ' >
    ...
    public function inline_public_css() {
        ...
        foreach ($childdata as $v) {
            ...
            foreach ($datas as $key => $data) {
                $css .= '.' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-12.oxi-addons-parent-wrapper-style-12-' . $v['id'] . ' .member-icon.member-icon-' . $key . ' .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color'] . ';' : '' ) . '
                            
                            }
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-12.oxi-addons-parent-wrapper-style-12-' . $v['id'] . ' .member-icon.member-icon-' . $key . '{
                        ...
                        .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-12.oxi-addons-parent-wrapper-style-12-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover .oxi-icons{
                            ' . (($styledata["sa_social_icons_position"] == "separately") ? 'color: ' . $data['sa_social_icons_color_hover'] . ';' : '' ) . '
                           }
                           .' . $this->WRAPPER . ' .oxi-addons-parent-wrapper-style-12.oxi-addons-parent-wrapper-style-12-' . $v['id'] . ' .member-icon.member-icon-' . $key . ':hover{
