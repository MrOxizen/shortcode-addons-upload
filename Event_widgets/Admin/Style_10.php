        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_event_widgets_border' => [
                    ...
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}}  .oxi-addons-EW-10-wrapper-style-10.oxi-addons-EW-10-wrapper-style-10-{{KEY}} .oxi-addons-EW-10-BG' => ''
                    ],
                ],
                'sa_event_widgets_footer_color' => [
                    'label' => __('Footer Background', SHORTCODE_ADDOONS),
                    'type' => Controls::COLOR,
                    'default' => 'rgba(255, 66, 113,1.00)',
                    'oparetor' => 'RGB',
                    'selector' => [
                        '{{WRAPPER}}  .oxi-addons-EW-10-wrapper-style-10.oxi-addons-EW-10-wrapper-style-10-{{KEY}} .oxi-addons-EW-10-F-TL' => 'background : {{VALUE}}; '
                    ],
                ],
            ],
                ]
