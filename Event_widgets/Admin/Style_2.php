    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_event-widgets_date_and_month_bg' => [
                    ...
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-EW-wrapper-style-2.oxi-addons-EW-wrapper-style-2-{{KEY}} .oxi-addons-EW-2-date-month ' => ''
                    ],
                ],
                'sa_event_t_head' => [
                ...
                'sa_event_widgets_bg' => [
                    ...
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-EW-wrapper-style-2.oxi-addons-EW-wrapper-style-2-{{KEY}} .oxi-addons-EW-2-C-body' => '',
                    ],
                ],
                'sa_event_widgets_border' => [
                    ...
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-EW-wrapper-style-2.oxi-addons-EW-wrapper-style-2-{{KEY}} .oxi-addons-EW-2-wrapper-row' => '',
                    ],
                ],
            ],
                ]
        ...
        $this->start_controls_tabs(
            ...
            'options' => [
                ...
                'location' => esc_html__('Location Text', SHORTCODE_ADDOONS),
            ]
                ]
        );
        $this->start_controls_tab();
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-EW-wrapper-style-2 .oxi-addons-EW-2-button' => 'text-align:{{VALUE}}',
            ],
                ]
        );
        $this->add_group_control(
