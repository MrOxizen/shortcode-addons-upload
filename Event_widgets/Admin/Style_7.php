...
class Style_7 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_event_t_ovely_bg' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}}  .oxi-addons-EW-7-wrapper-style-7.oxi-addons-EW-7-wrapper-style-7-{{KEY}} .oxi-addons-EW-7-body' => 'background : {{VALUE}}; '
                    ],
                ],
            ],
                ]
        ...
        $this->add_responsive_control(
            ...
            'label' => __('Overly Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
                'size' => '',
        ...
        $this->start_controls_section(
         ...
         $this->start_controls_tabs(
            ...
            'options' => [
                ...
                'hover' => esc_html__('Date & Time', SHORTCODE_ADDOONS),
