...
class Style_1 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        if (array_key_exists('sa_post_carousel_arrow', $style) && $style['sa_post_carousel_arrow'] == 'yes') {
            $arrow = '
                <div class="swiper-button-next  sa_post_carousel_swiper_button_next_' . $this->oxiid . '">
                    ' . $arrow_left . '
                </div>
                <div class="swiper-button-prev sa_post_carousel_swiper_button_prev_' . $this->oxiid . '">
                    ' . $arrow_right . '
                </div>
            ';
        }
        echo '<div class="oxi-addons__post-carousel-style-1">
                    <div class="swiper-container oxi-addons__post-carousel-wrap" >
                        <div class="swiper-wrapper">
                            ' . $this->post_render() . '
                        </div>
                    </div>';
        if (array_key_exists('sa_post_carousel_dots', $style) && $style['sa_post_carousel_dots'] == 'yes') :
            echo '<div class="swiper-pagination sa_post_carousel_swiper_pagination_' . $this->oxiid . '"></div>';
        endif;
        echo $arrow;
        echo '</div>
            ';
    ...
    {
        $style = $this->style;
        $prev = '.sa_post_carousel_swiper_button_next_' . $this->oxiid . '';
        $next = '.sa_post_carousel_swiper_button_prev_' . $this->oxiid . '';
        $pagin = '.sa_post_carousel_swiper_pagination_' . $this->oxiid . '';
        ...
        $js = 'var sa_post_carousel = $(".' . $this->WRAPPER . ' .oxi-addons__post-carousel-style-1 .oxi-addons__post-carousel-wrap");
            ...
            var saPostCarousel = new Swiper(sa_post_carousel, {
                ...
                pagination: {
                    el: ".sa_post_carousel_swiper_pagination_' . $this->oxiid . '",
                    clickable: true
                },
                navigation: {
                    nextEl: ".sa_post_carousel_swiper_button_next_178",
                    prevEl: ".sa_post_carousel_swiper_button_prev_178"
                },
                // navigation: {
                //     nextEl: ".sa_post_carousel_swiper_button_prev_178",
                //     prevEl: ".sa_post_carousel_swiper_button_next_178"
                // },
                breakpoints: {
                    480: {
