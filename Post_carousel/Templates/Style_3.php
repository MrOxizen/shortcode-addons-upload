...
class Style_3 extends Templates
{
    ...
    function inline_public_css()
    {
        ...
        $final = ' .' . $this->WRAPPER . ' .oxi-addons__main-wrapper-style-3 .oxi-addons__overlay{
                        ' . $css_inline . '
                    }
                    .' . $this->WRAPPER . ' .oxi-addons__main-wrapper-style-3 .oxi-addons__main-img:hover .oxi-addons__overlay{
                        ' . $hoverData . '
                    }';
        return $final;
    }
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        echo '<div class="oxi-addons__post-carousel-style-3 swiper-container-wrap-dots-' . $style['dots_position'] . '">
    ...
    public function inline_public_jquery()
    {
        ...
        $js = '';
        $js = 'var sa_post_carousel = $(".' . $this->WRAPPER . ' .oxi-addons__post-carousel-style-3 .oxi-addons__post-carousel-wrap");
