...
class Style_2 extends Swiper_Settings_View
{
    ...
    function inline_public_css()
    {
        ...
        $final = ' .' . $this->WRAPPER . ' .oxi-addons__post-carousel-style-2 .oxi-addons__article_main{
                        ' . $css_inline . '
                    }
                    .' . $this->WRAPPER . ' .oxi-addons__post-carousel-style-2 .oxi-addons__wrapper:hover .oxi-addons__article_main{
                        ' . $hoverData . '
                    }';
        return $final;
    }
    public function post_render()
    {
        ...
        if ($query->have_posts()) {
            while ($query->have_posts()) {
                ...
                $title = $content_excerpt = $image_url = $button = '';
                ...
                echo '
                    <div class="oxi-addons__post-carousel-wrapper">
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        $this->slider_default_render('oxi-addons__post-carousel-style-2', $this->slider_data);
    }
}
