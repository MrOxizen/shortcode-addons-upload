    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-addons__wrapper::after' => 'padding-bottom:{{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-addons__article_main' => 'padding-bottom:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-addons__post-carousel-wrapper' => 'padding : {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-addons__wrapper:hover .oxi-addons__article_main' => 'background : {{VALUE}}; '
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-addons__title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Excerpt/Content Settings', SHORTCODE_ADDOONS),
                'showing' => TRUE,
                'condition' => [
                    'sa_s_image_layout_show_excerpt' => 'show',
                ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                'include' => Controls::ALIGNNORMAL,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-name' => '',
                ],
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#2ba5ba',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2  .oxi-name' => 'color:{{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#1cbfa4',
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-name:hover' => 'color:{{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons__post-carousel-style-2 .oxi-name' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->end_controls_tab();
