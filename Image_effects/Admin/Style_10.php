...
class Style_10 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_10 .sa_ie_inner' => 'box-shadow:{{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_10 .sa_ie_inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_10 .sa_ie_inner:hover' => 'box-shadow:{{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_10 .sa_ie_inner:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_10 .ihewc-hover-figure .ihewc-hover-figure-caption-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_10 ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
