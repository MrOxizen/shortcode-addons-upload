...
class Style_32 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_el_image_effect_title' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .sa_image_effect_temp_32_{{KEY}} .ihewc-heading ihewc-delay-sm' => '',
                    ],
                ],
                'sa_el_image_effect_descriptions' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .sa_image_effect_temp_32_{{KEY}} .ihewc-content.ihewc-delay-sm' => '',
                    ],
                ],
                'sa_el_image_effect_btn_text' => [
                    ...
                    'default' => 'Buy Now',
                    'selector' => [
                        '{{WRAPPER}} .sa_image_effect_temp_32_{{KEY}} .oxi-addons-image-effects-button' => '',
                    ],
                ],
        ...
        $this->add_control(
            ...
            'type' => Controls::SELECT,
            'default' => 'ihewc-zoom-in',
            'loader' => TRUE,
            'options' => [
                'ihewc-zoom-in' => __('Zoom In', SHORTCODE_ADDOONS),
                'ihewc-zoom-out' => __('Zoom Out', SHORTCODE_ADDOONS),
                'ihewc-zoom-out-up' => __('Zoom Out Up', SHORTCODE_ADDOONS),
                'ihewc-zoom-out-down' => __('Zoom Out Down', SHORTCODE_ADDOONS),
                'ihewc-zoom-out-left' => __('Zoom Out Left', SHORTCODE_ADDOONS),
                'ihewc-zoom-out-right' => __('Zoom Out Right', SHORTCODE_ADDOONS),
                'ihewc-zoom-out-flip-horizontal' => __('Zoom Out Flip Horizontal', SHORTCODE_ADDOONS),
                'ihewc-zoom-out-flip-vertical' => __('Zoom Out Flip Vertical', SHORTCODE_ADDOONS),
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32  .ihewc-hover-image' => 'height:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .ihewc-hover-padding-32' => 'max-width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .sa_for_margin' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .sa_for_margin ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#fff',
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 h3.ihewc-heading' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 h3.ihewc-heading' => ''
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 h3.ihewc-heading' => 'text-align: {{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 h3.ihewc-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            'default' => '#fff',
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-content' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-content' => ''
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-content' => 'text-align: {{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => ''
            ],
                ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            'default' => '#000',
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'oparetor' => 'RGB',
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => 'background:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => 'box-shadow:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#222',
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-button.img-btn:hover' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'oparetor' => 'RGB',
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-button.img-btn:hover' => 'background:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-button.img-btn:hover' => 'box-shadow:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-button.img-btn:hover' => ''
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .ihewc-button.img-btn:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .oxi-addons-image-effects-button' => 'text-align: {{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .sa_ie_temp_32 .img-btn.ihewc-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_section_devider();
