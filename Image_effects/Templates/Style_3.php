...
class Style_3 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('css_handaller_file_temp_3_blinds', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-blur-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
        wp_enqueue_style('css_handaller_file_temp_3_global', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo $alignments;
//            echo '<pre>';
//            print_r($style);   ' . $style['sa_effects_select_icon'] . '
//            echo '</pre>';
