...
class Style_20 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('Image_effects_pixel_effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-pixel-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="  sa_ie_temp_style_20   ' . $this->column_render('sa-ac-column', $style) . ' " >';
            echo '<div class="sa_ie_temp_20 ihewc-hover-padding-20 oxi-m-width" ' . $this->animation_render('sa-ie-main-box-animation', $style) . '>
                <div class="sa_for_margin">
                ' . $valueurl1st . '
                    <div class="ihewc-hover sa_image_effect_temp_20 sa_image_effect_temp_20_' . $key . '  ' . $style['sa_effects_select_icon'] . '">
