...
class Style_26 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('css_handaller_file_slide-effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-slide-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="      sa_ie_temp_style_26       ' . $this->column_render('sa-ac-column', $style) . ' " >';
            echo '<div class="sa_ie_temp_26 ihewc-hover-padding-26 oxi-m-width" ' . $this->animation_render('sa-ie-main-box-animation', $style) . '>
                <div class="sa_for_margin">
                ' . $valueurl1st . '
                    <div class="ihewc-hover sa_image_effect_temp_26 sa_image_effect_temp_26_' . $key . '  ' . $style['sa_effects_select_icon'] . '">
