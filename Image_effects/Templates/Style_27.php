...
class Style_27 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('css_handaller_file_splash-effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-splash-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
