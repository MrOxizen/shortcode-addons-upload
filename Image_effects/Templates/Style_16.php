...
class Style_16 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('css_handaller_file_temp_16_blinds', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-lightspeed-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
        wp_enqueue_style('css_handaller_file_temp_16_global', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="sa_ie_temp_16 ihewc-hover-padding-16 oxi-m-width" ' . $this->animation_render('sa-ie-main-box-animation', $style) . '>
                <div class="sa_for_margin">
                ' . $valueurl1st . '
                    <div class="ihewc-hover sa_image_effect_temp_16 sa_image_effect_temp_16_' . $key . '  ' . $style['sa_effects_select_icon'] . '">
