...
class Style_1 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('css_handaller_file_temp_1_blinds', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-blinds-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
        wp_enqueue_style('css_handaller_file_temp_1_global', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
           ...
           if (array_key_exists('sa_el_image_effect_url-url', $data) && $data['sa_el_image_effect_url-url'] != '') {
            ...
            echo '<div class="sa_ie_temp_1 ihewc-hover-padding oxi-m-width" ' . $this->animation_render('sa-ie-main-box-animation', $style) . '>
                <div class="sa_for_margin">
                '.$valueurl1st.'
                    <div class="ihewc-hover sa_image_effect_temp_1 sa_image_effect_temp_1_'.$key.'  ' . $style['sa_effects_select_icon'] . '">
