...
class Style_11 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('css_handaller_file_temp_11_blinds', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-fall-away-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
        wp_enqueue_style('css_handaller_file_temp_11_global', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="sa_ie_temp_11 ihewc-hover-padding-11 oxi-m-width" ' . $this->animation_render('sa-ie-main-box-animation', $style) . '>
                <div class="sa_for_margin">
                ' . $valueurl1st . '
                    <div class="ihewc-hover sa_image_effect_temp_11 sa_image_effect_temp_11_' . $key . '  ' . $style['sa_effects_select_icon'] . '">
