...
class Style_25 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('css_handaller_file_shutter-effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-shutter-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="  sa_ie_temp_style_25    ' . $this->column_render('sa-ac-column', $style) . ' " >';
            echo '<div class="sa_ie_temp_25 ihewc-hover-padding-25 oxi-m-width" ' . $this->animation_render('sa-ie-main-box-animation', $style) . '>
                <div class="sa_for_margin">
                ' . $valueurl1st . '
                    <div class="ihewc-hover sa_image_effect_temp_25 sa_image_effect_temp_25_' . $key . '  ' . $style['sa_effects_select_icon'] . '">
