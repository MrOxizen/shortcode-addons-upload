...
class Style_8 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('css_handaller_file_cube-effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-cube-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class=" sa_ie_temp_style_8  ' . $this->column_render('sa-ac-column', $style) . ' " >';
