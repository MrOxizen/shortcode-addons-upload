...
class Style_12 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('css_handaller_file_flash-effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-flash-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="  sa_ie_temp_style_12  ' . $this->column_render('sa-ac-column', $style) . ' " >';
