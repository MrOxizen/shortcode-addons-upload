...
class Style_5 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('css_handaller_file_temp_4_blinds', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-border-reveal-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
