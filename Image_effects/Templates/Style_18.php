...
class Style_18 extends Templates {
    ...
    public function public_css() {
        ...
        wp_enqueue_style('css_handaller_file_parallax-effects_css', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-parallax-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//            echo '</pre>';
            ...
            echo '<div class="  sa_ie_temp_style_18   ' . $this->column_render('sa-ac-column', $style) . ' " >';
