...
class Style_17 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('css_handaller_file_temp_17_blinds', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style-modal-effects.css', false, SA_ADDONS_PLUGIN_VERSION);
        wp_enqueue_style('css_handaller_file_temp_17_global', SA_ADDONS_UPLOAD_URL . '/Image_effects/File/Css/Style.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
