...
namespace SHORTCODE_ADDONS_UPLOAD\Interactive_cards\Templates;
...
class Style_1 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo ' <div class="oxi-addons-Interactive-card-style-1">
                        <div class="oxi-addons-IC"  ' . $this->animation_render('sa_interactive_cards_animation', $style) . '>
                            <div class="oxi-addons-ICfull-content" id="oxi-front-part-' . $this->oxiid . '">
    ...
    public function inline_public_jquery() {
        ...
        if (array_key_exists('sa_interactive_cards_loader', $style) && $style['sa_interactive_cards_loader'] != '0') {
            ...
            $jquery .= "jQuery(function () {
                            ...
                            jQuery('#oxi-front-part-$this->oxiid').on('click', function () {

                                jQuery('#oxi-load-part-$this->oxiid').removeClass('oxi-opacity-0');
                                jQuery('#oxi-front-part-$this->oxiid').addClass('oxi-opacity-0');
                                setTimeout(function() {
                            ...
                            jQuery('#oxi-close-icon-$this->oxiid').on('click', function () {
                               jQuery('#oxi-back-part-$this->oxiid').addClass('oxi-opacity-0');
                                jQuery('#oxi-load-part-$this->oxiid').removeClass('oxi-opacity-0');
                                setTimeout(function() {
                                        jQuery('#oxi-front-part-$this->oxiid').removeClass('oxi-opacity-0');
                                        jQuery('#oxi-load-part-$this->oxiid').addClass('oxi-opacity-0');
                                },  $dur);
                            });
                        });";
    ...
    public function inline_public_css() {
        ...
        if ($style['sa_interactive_cards_loader_style'] == 'style-1') {
            ...
            $css .= '       .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-loading {
                               ...
                               .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-loading div {
                                width: 1rem;
                                height: 1rem;
                                margin: 2rem 0.3rem;
                               ...
                               .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-loading div:nth-child(2) {
                                -webkit-animation-delay: 0.3s;
                                        animation-delay: 0.3s;
                              }
                               .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-loading div:nth-child(3) {
            ...
            $css .= '.oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-fancy-spinner {
                                        display: flex;
                                        justify-content: center;
                                        align-items: center;
                                        width: 5rem;
                                    ...
                                    .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-fancy-spinner div {
                                        position: absolute;
                                        width: 4rem;
                                        height: 4rem;
                                        border-radius: 50%;
                                    }
                                    .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-fancy-spinner div.oxi-addons-ring {
                                        border-width: 0.5rem;
                                        border-style: solid;
            ...
            $css .= '
                                    .oxi-addons-container .oxi-addons-Interactive-card-style-1  .oxi-addons-multi-ripple {
                                         width: 5.6rem;
                                         height: 5.6rem;
                                         margin: 5rem;
                                       }
                                    .oxi-addons-container .oxi-addons-Interactive-card-style-1  .oxi-addons-multi-ripple div {
                                         position: absolute;
                                         width: 5rem;
                                         height: 5rem;
                                         border-radius: 50%;
                                    ...
                                    .oxi-addons-container .oxi-addons-Interactive-card-style-1  .oxi-addons-multi-ripple div:nth-child(2) {
            ...
            $css .= '
                                    .oxi-addons-container .oxi-addons-Interactive-card-style-1 .oxi-addons-donut {
                                     width: 5rem;
                                     height: 5rem;
                                     margin: 5rem;
                                     border-radius: 50%;
    ...
    public function old_render() {
        ...
        $pos = $oxi_url = $icon = $back_part = '';
        $css = '';
        $loader = $load_part = $jquery = '';
                    ...
                    <div class="oxi-addons-row">
                        <div class="oxi-addons-Interactive-card-' . $oxiid . '">
                            <div class="oxi-addons-IC"  ' . OxiAddonsAnimation($styledata, 29) . '>
                                <div class="oxi-addons-ICfull-content" id="oxi-front-part-' . $oxiid . '">
                                    <div class="oxi-addons-IC-box">
                                        <div class="oxi-addons-IC-body">
                                            <div class="oxi-addons-image ">
                                                ' . $oxi_url . '
        ...
        $css .= '
                    ...
                    .oxi-addons-container .oxi-addons-Interactive-card-' . $oxiid . ' .oxi-addons-IC .oxi-addons-ICfull-content {
                            width: 100%;
                            float:left;
        ...
        if ($styledata[109] == 'on') {
            ...
            $jquery .= "jQuery(function () {
                            ...
                            jQuery('#oxi-front-part-$oxiid').on('click', function () {

                                jQuery('#oxi-load-part-$oxiid').removeClass('oxi-opacity-0');
                                jQuery('#oxi-front-part-$oxiid').addClass('oxi-opacity-0');
                                setTimeout(function() {
                            ...
                            jQuery('#oxi-close-icon-$oxiid').on('click', function () {
                               jQuery('#oxi-back-part-$oxiid').addClass('oxi-opacity-0');
                                jQuery('#oxi-load-part-$oxiid').removeClass('oxi-opacity-0');
                                setTimeout(function() {
                                        jQuery('#oxi-front-part-$oxiid').removeClass('oxi-opacity-0');
                                        jQuery('#oxi-load-part-$oxiid').addClass('oxi-opacity-0');
                                }, $styledata[115]);
                            });
                        });";
