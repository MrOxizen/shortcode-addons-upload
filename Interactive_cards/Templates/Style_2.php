...
class Style_2 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo ' <div class="oxi-addons-Interactive-card-style-2">
    ...
    public function inline_public_css() {
        ...
        if ($style['sa_interactive_cards_loader_style'] == 'style-1') {
            ...
            $css .= '       .oxi-addons-container  .oxi-addons-loading {
                                display: flex;
                                justify-content: center;
                              }
                               .oxi-addons-container  .oxi-addons-loading div {
                                width: 1rem;
                                height: 1rem;
                                margin: 2rem 0.3rem;
                               ...
                               .oxi-addons-container  .oxi-addons-loading div:nth-child(2) {
                                -webkit-animation-delay: 0.3s;
                                        animation-delay: 0.3s;
                              }
                               .oxi-addons-container  .oxi-addons-loading div:nth-child(3) {
            ...
            $css .= '.oxi-addons-container  .oxi-addons-fancy-spinner {
                                        display: flex;
                                        justify-content: center;
                                        align-items: center;
                                        width: 5rem;
                                    ...
                                    .oxi-addons-container  .oxi-addons-fancy-spinner div {
                                        position: absolute;
                                        width: 4rem;
                                        height: 4rem;
                                        border-radius: 50%;
                                    }
                                    .oxi-addons-container  .oxi-addons-fancy-spinner div.oxi-addons-ring {
                                        border-width: 0.5rem;
                                        border-style: solid;
            ...
            $css .= '
                                    .oxi-addons-container   .oxi-addons-multi-ripple {
                                         width: 5.6rem;
                                         height: 5.6rem;
                                         margin: 5rem;
                                       }
                                    .oxi-addons-container   .oxi-addons-multi-ripple div {
                                         position: absolute;
                                         width: 5rem;
                                         height: 5rem;
                                         border-radius: 50%;
                                    ...
                                    .oxi-addons-container   .oxi-addons-multi-ripple div:nth-child(2) {
            ...
            $css .= '
                                    .oxi-addons-container  .oxi-addons-donut {
                                     width: 5rem;
                                     height: 5rem;
                                     margin: 5rem;
                                     border-radius: 50%;
