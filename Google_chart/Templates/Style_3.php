...
//        echo '</pre>';
    ...
    public function inline_public_jquery() {
        ...
        $datas = (array_key_exists('sa_google_chart_data_style_3', $listdata) && is_array($listdata['sa_google_chart_data_style_3']) ? $listdata['sa_google_chart_data_style_3'] : []);
        ...
        $background_color = $listdata['sa-google_chart_inside_background_color'];
        $borderColor_color = $listdata['sa-google_chart_inside_border_color'];
    ...
    ';
        ...
        data: {
            ...
            datasets: [{
                ...
                pointBorderWidth: $styledata[90],
                backgroundColor: '$styledata[95]',
                borderColor: '$styledata[101]',
                borderWidth: $styledata[97],
            }]
        },
        options: {
            scales: {
