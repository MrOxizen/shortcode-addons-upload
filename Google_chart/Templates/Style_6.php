...
class Style_6 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('jquery_google_style_6_css', SA_ADDONS_UPLOAD_URL . '/Google_chart/File/chart-min.css', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
//        echo '</pre>';
        ...
        echo '<div class="oxi-addons-chart-style-6">
                    <div class="oxi-addons-chart-' . $oxiid . '" ' . $this->animation_render('sa-google-chart-body-animation', $styledata) . '>
                         <canvas id="oxi-addons-pie-' . $oxiid . '" width="' . $styledata['sa-google_chart_body_max_width-size'] . 'px" height="' . $styledata['sa-google_chart_body_max_height-size'] . 'px"></canvas>
                   </div>
            </div>';
    }
    ...
    public function inline_public_jquery() {
        ...
        $jquery .= "new Chart(document.getElementById('oxi-addons-pie-$oxiid'), {
                    type: 'pie',
                    data: {
    ...
    public function public_jquery() {
        $this->JSHANDLE = 'jquery_google_style_6_js';
        wp_enqueue_script('jquery_google_style_6_js', SA_ADDONS_UPLOAD_URL . '/Google_chart/File/chart-min.js', false, SA_ADDONS_PLUGIN_VERSION);
    }
...
<div class="oxi-addons-container">
    <div class="oxi-addons-row">';
        ...
        echo '<div class="oxi-addons-chart-' . $oxiid . '" ' . OxiAddonsAnimation($styledata, 59) . '>
           <canvas id="oxi-addons-pie-' . $oxiid . '" width="' . $styledata[23] . 'px" height="' . $styledata[27] . 'px"></canvas>
        </div>
      </div>
</div>
