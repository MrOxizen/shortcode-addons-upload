...
class Style_2 extends Templates {
    ...
    public function public_css() {
        wp_enqueue_style('jquery_google_style_2_css', SA_ADDONS_UPLOAD_URL . '/Google_chart/File/chart-min.css', false, SA_ADDONS_PLUGIN_VERSION);
    }

    public function default_render($style, $child, $admin) {
        $styledata = $this->style; 
        $oxiid = $styledata['shortcode-addons-elements-id'];
        echo '<div class="oxi-addons-chart-style-2">
    ...
    public function inline_public_jquery() {
        ...
        $datas = (array_key_exists('sa_google_chart_data_style_2', $listdata) && is_array($listdata['sa_google_chart_data_style_2']) ? $listdata['sa_google_chart_data_style_2'] : []);
...
<div class="oxi-addons-container">
    <div class="oxi-addons-row">';
        ...
        echo '<div class="oxi-addons-chart-' . $oxiid . '" ' . OxiAddonsAnimation($styledata, 59) . '>
           <canvas id="oxi_addons_bar_chart_H_' . $oxiid . '" width="' . $styledata[23] . 'px" height="' . $styledata[27] . 'px"></canvas>
        </div>
      </div>
</div>
...
';
    ...
    ';
        ...
        $jquery .= "var ctx = document.getElementById('oxi_addons_bar_chart_H_$oxiid');
        var oxi_addons_bar_chart_H_$oxiid = new Chart(ctx, {
        type: 'horizontalBar',
        data: {
            labels:[$oxi_addons_labels],
            datasets: [{
