    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_2 .oxi_addons__text' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_2 .oxi_addons__text' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
