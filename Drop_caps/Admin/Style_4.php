    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => 'w',
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4 .oxi_addons__text' => '',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4' => 'float:{{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4 .oxi_addons__text' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4 .oxi_addons__text' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4 .oxi_addons__text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                //  'loader' => TRUE,
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4 .oxi_addons__text' => 'color:{{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}.oxi_addons__drop_caps_main_style_4 .oxi_addons__text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
