...
class Style_4 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($all_data as $key => $data) {
            ...
            echo '<div class="oxi_addons_button_effect_style_4   sa_o_f_m   oxi_addons_button_effect_style_4_' . $key . '   "  ' . $this->animation_render('sa-be-main-box-animation', $style) . '>';
    ...
    public function old_render() {
        ...
        $css = '.oxi-button-hover-' . $oxiid . '{
           ...
           .oxi-button-hover-' . $oxiid . ' .oxi-button-img img{
            ...
            .oxi-button-hover-' . $oxiid . ' .oxi-button-left-to-right .oxi-button-hover a{
                transform: scale(0);
            }
            .oxi-button-hover-' . $oxiid . ' .oxi-button-right-to-left .oxi-button-hover a{
                transform: scale(2);
            }
            .oxi-button-hover-' . $oxiid . ' .oxi-button-left-to-right .oxi-button-hover:hover a,
            .oxi-button-hover-' . $oxiid . ' .oxi-button-right-to-left .oxi-button-hover:hover a{
                transform: scale(1);
            }
