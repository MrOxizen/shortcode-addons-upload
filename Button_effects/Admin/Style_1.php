...
class Style_1 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_el_be_first_icon' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi_addons_button_effect_style_1_{{KEY}} .oxi-button-info' => '',
                    ],
                ],
                'sa_el_be_first_url' => [
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover' => 'box-shadow:{{VALUE}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover:hover' => 'box-shadow:{{VALUE}};'
            ],
                ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover-map-139' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1' => 'height:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1' => 'width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'loader' => true,
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-info' => ''
            ],
                ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => 'font-size:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => 'height:{{SIZE}}{{UNIT}}; width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#fff',
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => 'background:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => ''
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover:hover a .oxi-icons:hover' => 'color:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover:hover a .oxi-icons:hover' => 'background:{{VALUE}};'
            ],
                ]
        );
        $this->add_control(
            ...
            'default' => '#787878',
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover:hover a .oxi-icons:hover' => 'border-color:{{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover:hover a .oxi-icons:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons_button_effect_style_1 .oxi-button-hover a .oxi-icons' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
