                    ...
                    <div class="oxi-addons-single-image-row">
                        <div class="oxi-addons-single-image">
                            ...
                            <div class="oxi-addons-single-image-icon">
                                ' . ($style['sa_s_image_light_or_link'] == 'link' ? '<a  ' . $this->url_render('sa_s_image_link_url', $style) . '><div class="oxi-addons-single-image-icon-data">' . $this->text_render($style['sa_s_image_button']) . ' </div></a>' : '<div class="oxi-addons-single-image-icon-data">' . $this->text_render($style['sa_s_image_button']) . ' </div>') . '
                            </div>
                        </div>
                        ' . $ribbon . '
                    </div>
