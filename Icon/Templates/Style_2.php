...
class Style_2 extends Templates
{
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        foreach ($datas as $key => $value) {
            ...
            echo '  <div class="oxi_addons__icon_main_wrapper  ' . $this->column_render('sa_icon_column', $style) . '">
                            <div class="oxi_addons__icon_main_style_2 oxi_addons__icon_main-' . $key . '" >
                                ' . $icon . '
                            </div>
                        ';
    ...
    public function old_render()
    {
        ...
        foreach ($listdata as $value) {
            ...
            echo '<div class="' . OxiAddonsItemRows($styledata, 41) . ' oxi-addons-center" ' . OxiAddonsAnimation($styledata, 23) . '>';
            if ($listfiles[7] != '') {
