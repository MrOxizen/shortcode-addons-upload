...
class Style_7 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'loader' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd7' => 'z-index:{{VALUE}};',
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd7 .oxi-addons-divider.sa_sd_scrolling' => 'animation-duration: {{SIZE}}{{UNIT}}',
            ],
            'condition' => [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd7' => 'width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd7' => 'height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
