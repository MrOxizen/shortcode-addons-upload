...
class Style_5 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            'loader' => TRUE,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd5' => 'z-index:{{VALUE}};',
            ],
                ]
        );
        $this->add_control(
...
$this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd5 .oxi-addons-divider.sa_sd_scrolling' => 'animation-duration: {{SIZE}}{{UNIT}}',
             ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd5' => 'width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-addons-divider-sd5' => 'height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
