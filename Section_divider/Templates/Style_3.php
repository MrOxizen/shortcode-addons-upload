...
class Style_3 extends Templates {
    ...
    public function old_render() {
        ...
        .oxi-addons-divider-<?php echo $oxiid; ?> .oxi-addons-divider{
            background-image: url("data:image/svg+xml,%3Csvg class='rocket-separator tilt_left_svg_separator' xmlns='http://www.w3.org/2000/svg' version='1.0' width='100%25' fill='%23<?php echo $style[11]; ?>' height='100%25' viewBox='0 0 1920 90' preserveAspectRatio='none'%3E%3Cpath d='M0,0H1920L0,90V0Z'%3E%3C/path%3E%3C/svg%3E");
            background-repeat:  repeat-x;
        } 
    </style>
    <?php
