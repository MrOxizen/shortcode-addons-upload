    ...
    public function old_render() {
        ...
        <style>
            .oxi-addons-divider-<?php echo $oxiid; ?> .oxi-addons-divider{
                background-image: url("data:image/svg+xml,%3Csvg class='rocket-separator big_triangle_center_svg_separator' xmlns='http://www.w3.org/2000/svg' version='1.0' width='100%25' fill='%23<?php echo $style[11]; ?>' height='100%25' viewBox='0 0 1920 57' preserveAspectRatio='none'%3E%3Cpath d='M0,0H960V57ZM1920,0H960V57Z'%3E%3C/path%3E%3C/svg%3E");
                background-repeat:  repeat-x;
            } 
        </style>
        <?php
