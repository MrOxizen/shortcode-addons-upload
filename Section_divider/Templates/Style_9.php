...
class Style_9 extends Templates {
    ...
    public function inline_public_css() {
        ...
        $css = '.' . $this->WRAPPER . ' .oxi-addons-divider-sd9 .oxi-addons-divider{
                background-image: url("data:image/svg+xml,%3Csvg class=\'rocket-separator big_triangle_center_svg_separator\' xmlns=\'http://www.w3.org/2000/svg\' version=\'1.0\' width=\'100%25\' fill=\'%23' . $color. '\' height=\'100%25\' viewBox=\'0 0 1920 57\' preserveAspectRatio=\'none\'%3E%3Cpath d=\'M0,0H960V57ZM1920,0H960V57Z\'%3E%3C/path%3E%3C/svg%3E");
    ...
    public function default_render($style, $child, $admin) {
        ...
        echo '  <div class="oxi-addons-divider-sd9 ' . $style['sa_sd_align'] . '">
    ...
    public function old_render() {
        ...
        <style>
            .oxi-addons-divider-<?php echo $oxiid; ?> .oxi-addons-divider{
                background-image: url("data:image/svg+xml,%3Csvg class='rocket-separator big_triangle_center_svg_separator' xmlns='http://www.w3.org/2000/svg' version='1.0' width='100%25' fill='%23<?php echo $styledata[11]; ?>' height='100%25' viewBox='0 0 1920 57' preserveAspectRatio='none'%3E%3Cpath d='M0,0H960V57ZM1920,0H960V57Z'%3E%3C/path%3E%3C/svg%3E");
                background-repeat:  repeat-x;
            } 
        </style>
        <?php
