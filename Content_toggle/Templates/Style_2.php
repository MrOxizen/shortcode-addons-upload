...
namespace SHORTCODE_ADDONS_UPLOAD\Elements\Content_toggle\Templates;
...
class Style_2 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        if (!empty($style['sa_ct_first_content'])) {
            $content_one = '<div class="oxi-addons-CT-2-content-One">' . $this->text_render($style['sa_ct_first_content']) . '</div>';
        }
        if (!empty($style['sa_ct_second_content'])) {
            $content_two = '<div class="oxi-addons-CT-2-content-two">' . $this->text_render($style['sa_ct_second_content']) . '</div>';
        }
        echo '<div class="oxi-addons-CT-2">
                    <div class="oxi-addons-CT-2-row">
			<div class="oxi-addons-CT-2-Switch-area">
                            ' . $before . '
                            <div class="oxi-addons-CT-2-Switch">
				<input class="oxi-addons-CT-2-checkbox" type="checkbox" name="oxi-addons-switch" class="checkbox" />  
				<div class="oxi-addons-switch"></div> 
                            </div>
                            ' . $after . '
                        </div>
                        <div class="oxi-addons-CT-2-main-content">
                            ' . $content_one . '
                            ' . $content_two . '
                        </div>
                    </div>
    ...
    public function old_render() {
        ...
        .oxi-addons-CT-' . $oxiid . ' .oxi-addons-before-text.oxi-active{
            font-size: ' . $styledata[3] . 'px;
            color: ' . $styledata[7] . ';
            ' . OxiAddonsFontSettings($styledata, 9) . '
            padding:  ' . OxiAddonsPaddingMarginSanitize($styledata, 15) . '; 
        ...
        .oxi-addons-CT-' . $oxiid . ' .oxi-addons-after-text.oxi-active{
            font-size: ' . $styledata[31] . 'px;
            color: ' . $styledata[177] . ';
            ' . OxiAddonsFontSettings($styledata, 37) . '
            padding:  ' . OxiAddonsPaddingMarginSanitize($styledata, 43) . '; 
       ...
       .oxi-addons-CT-' . $oxiid . '{
        ...
        $jquery = 'jQuery(document).ready(function () {
            jQuery(".oxi-addons-CT-' . $oxiid . ' .oxi-addons-switch").click(function () {
                ...
                jQuery(".oxi-addons-CT-' . $oxiid . ' .oxi-addons-before-text").toggleClass("oxi-active");
                jQuery(".oxi-addons-CT-' . $oxiid . ' .oxi-addons-after-text").toggleClass("oxi-active");
            });
