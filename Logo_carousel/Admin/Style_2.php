    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2' => '',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => true,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .swiper__container_slide' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .swiper__container_slide' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'sa_logo_carousel_body_switcher' => 'swiper__container_slide', 
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__image' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__image' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'sa_logo_carousel_image_switcher' => 'oxi__image_height_width', 
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#28a745', 
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__image' => 'background:{{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__image' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__image:hover' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__title' => '',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#111',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__title' => 'color:{{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__icon_left' => 'left: {{SIZE}}px;',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__icon_right' => 'right: {{SIZE}}px;',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi-icons' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__icon_left' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__icon_right' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi-icons' => 'color:{{VALUE}};', 
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_left' => 'background-color:{{VALUE}};',
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_right' => 'background-color:{{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_left' => '',
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_right' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_left' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_right' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi-icons:hover' => 'color:{{VALUE}};', 
                ],
            ]
        ); 
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}}  .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_left:hover' => 'background-color:{{VALUE}};',
                    '{{WRAPPER}}  .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_right:hover' => 'background-color:{{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_left:hover' => 'border-color:{{VALUE}};', 
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_right:hover' => 'border-color:{{VALUE}};', 
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_left:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2  .oxi_addons__icon_right:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet' => 'background:{{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#000',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet.swiper-pagination-bullet-active' => 'background:{{VALUE}};', 
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BORDER,
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet' => '',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'oparetor' => 'RGB',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet:hover' => 'background:{{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}} .oxi_addons__logo_carousel_style_2 .oxi_addons__dot .swiper-pagination-bullet:hover' => 'border-color:{{VALUE}};', 
                ],
            ]
        ); 
        $this->end_controls_tab();
