...
class Style_3 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            'sa_headers_icon_button_position',
            $this->style,
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-headers-wrapper-style-3 .oxi-addons-main-button' => 'justify-content : {{VALUE}};'
                ],
            ]
        );
        $this->add_control(
