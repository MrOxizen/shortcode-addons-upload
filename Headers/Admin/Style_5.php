    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-headers-wrapper-style-5' => 'justify-content: {{VALUE}};'
                ],

            ]
        );
        $this->add_responsive_control(
            'sa_headers_button_position',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-headers-wrapper-style-5 .oxi-addons-wrapper-left-side' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
