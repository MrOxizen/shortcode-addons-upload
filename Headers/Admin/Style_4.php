...
class Style_4 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_group_control(
            'sa_headers_content_bg',
            $this->style,
            [
                'type' => Controls::BACKGROUND,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-headers-wrapper-style-4 .oxi-addons-wrapper-left-side' => ''
                ],
            ]
        );
        $this->add_responsive_control(
            'sa_headers_content_padding',
            $this->style,
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-headers-wrapper-style-4 .oxi-addons-wrapper-left-side' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
