...
class Style_2 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            'sa-image-comparison-handle-bg-color',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-image-comparison-handle-width',
            $this->style,
            [
                'label' => __('Width', SHORTCODE_ADDOONS),
                'type' => Controls::SLIDER,
        ...
        $this->add_control(
            'sa_image_compersion_button_controler',
            $this->style,
            [
        ...
        $this->add_control(
            'sa-image-comparison-button-bg-color',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa-image-comparison-button-text-shadow',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-image-comparison-button-button-border-radius',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa-image-comparison-button-button-padding',
            $this->style,
            [
