...
class Style_10 extends AdminStyle
{
    ...
    public function register_controls()
    {
        ...
        $this->start_controls_tab();
        $this->add_group_control(
            'sa_el_ac_title_background_hover',
            $this->style,
            [
                'type' => Controls::BACKGROUND,
                'selector' => [
        ...
        $this->add_group_control(
            'sa_el_ac_opening_icon_icon_border',
            $this->style,
            [
                'type' => Controls::BORDER,
                'selector' => [
        ...
        $this->add_control(
            'sa_el_ac_opening_icon_active_adding',
            $this->style,
            [
        ...
        $this->add_control(
            'sa_el_ac_opening_icon_deactive_adding',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'sa_el_ac_arrow_height_and_width',
            $this->style,
            [
        ...
        $this->add_control(
            'sa_el_ac_closing_arrow_background',
            $this->style,
            [
                'label' => __('Background', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->add_control(
            'sa_el_ac_closing_arrow_hover_color',
            $this->style,
            [
                'label' => __('Color', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->add_control(
            'sa_el_ac_closing_arrow_hover_background',
            $this->style,
            [
                'label' => __('Background', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->add_control(
            'sa_el_ac_closing_arrow_hover_border',
            $this->style,
            [
                'label' => __('Border Color', SHORTCODE_ADDOONS),
                'type' => Controls::COLOR,
        ...
        $this->end_controls_tabs();
        $this->add_responsive_control(
            'sa_el_ac_closing_arrow_border_radius',
            $this->style,
            [
                'label' => __('Border Radius', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
        ...
        $this->add_responsive_control(
            'sa_el_ac_opening_arrow_padding',
            $this->style,
            [
                'label' => __('Margin', SHORTCODE_ADDOONS),
                'type' => Controls::DIMENSIONS,
