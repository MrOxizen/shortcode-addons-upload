    ...
    public function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_icon_boxes_container_style_3' => 'max-width: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_icon_box_h_text' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .sa_addons_icon_boxes_style_3.sa_addons_icon_boxes_style_3_{{KEY}} .sa_addons_icon_boxes_headding' => ''
                        ],
                    ],
                    'sa_icon_box_content' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .sa_addons_icon_boxes_style_3.sa_addons_icon_boxes_style_3_{{KEY}} .sa_addons_icon_boxes_content' => ''
                        ],
                    ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_icon_boxes_container_style_3' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
        $this->end_controls_section();
