...
class Style_4 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons__info_boxes_main_style_4' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi_addons__info_boxes_main_style_4:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
                'sa_icon_icon_width_height', $this->style, [
        ...
        $this->start_controls_tab();
        $this->add_control(
                'sa_info_hover_color', $this->style, [
        ...
        $this->add_group_control(
                'sa_info_boxes_icon_hover_border', $this->style, [
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oxi_addons__icon_style_4:hover .oxi-icons' => ''
            ],
                ]
        );
        $this->add_responsive_control(
                'sa_info_boxes_info_border_radius_hover', $this->style, [
            'label' => __('Border Radius', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
