...
class Style_6 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                'sa_logo_showcase_hover_text' => [
                    'label' => esc_html__('Hover Text', SHORTCODE_ADDOONS),
                    'type' => Controls::TEXT,
                    'default' => 'Git',
                    'selector' => [
                        '{{WRAPPER}} .sa_addons_logo_showcase_style_6.sa_addons_logo_showcase_style_6_{{KEY}} .sa_addons_logo_showcase_hover_text' => ''
                    ],
                ],
            ...
            'title_field' => 'sa_logo_showcase_hover_text',
            'button' => 'Add New Logo',
                ]
        );
        ...
        $this->add_group_control(
                'sa_logo_showcase_hover_text_typo', $this->style, [
        ...
        $this->add_control(
                'sa_logo_showcase_hover_text_color', $this->style, [
            'label' => __('Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#ffffff',
            'selector' => [
                '{{WRAPPER}} .sa_addons_logo_showcase_style_6 .sa_addons_logo_showcase_hover_text' => 'color: {{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
                'sa_logo_showcase_hover_text_bg', $this->style, [
            'type' => Controls::BACKGROUND,
            'selector' => [
                '{{WRAPPER}} .sa_addons_logo_showcase_style_6 .sa_addons_logo_showcase_hover_text' => ''
            ],
        ...
        $this->add_responsive_control(
                'sa_logo_showcase_hover_text_p', $this->style, [
            'label' => __('Padding', SHORTCODE_ADDOONS),
            'type' => Controls::DIMENSIONS,
            'default' => [
                'unit' => 'px',
