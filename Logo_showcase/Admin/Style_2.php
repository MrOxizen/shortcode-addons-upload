    ...
    public function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2 .sa_addons_img' => 'filter: grayscale({{SIZE}}{{UNIT}}); -webkit-filter: grayscale({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2' => ''
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2:hover .sa_addons_img' => 'filter: grayscale({{SIZE}}{{UNIT}}); -webkit-filter: grayscale({{SIZE}}{{UNIT}});',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'type' => Controls::BOXSHADOW,
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2:hover' => ''
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2' => 'max-width: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2:after' => 'padding-bottom: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .sa_addons_logo_showcase_style_2 .sa_addons_img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ],
            ]
        );
