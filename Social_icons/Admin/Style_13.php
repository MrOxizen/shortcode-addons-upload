                ...
                [
                    ...
                    'fields' => [
                        ...
                        'sa_social_icons_bg_color' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-13-{{KEY}} a.oxi-icon-style-13' => 'background:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_bg_color_hover' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-13-{{KEY}} a.oxi-icon-style-13:hover ' => 'background:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
