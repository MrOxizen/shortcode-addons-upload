    ...
    public function register_controls() {
                ...
                [
                    ...
                    'fields' => [
                        ...
                        'sa_social_icons_color' => [
                            ...
                            'default' => '#8500c2',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-16-{{KEY}} a.oxi-icon-style-16 .oxi-icons' => 'color:{{VALUE}};',
                            ],
                        ...
                        'sa_social_icons_color_hover' => [
                            ...
                            'default' => '#fff',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-16-{{KEY}} a.oxi-icon-style-16:hover .oxi-icons' => 'color:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_bg_color' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-16.oxi-addons-social-style-16-{{KEY}} a.oxi-icon-style-16' => 'background:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_bg_color_hover' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-16.oxi-addons-social-style-16-{{KEY}} a.oxi-icon-style-16:hover ' => 'background:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_box_shadow_sep' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-16.oxi-addons-social-style-16-{{KEY}} a.oxi-icon-style-16' => ''
                            ], 'condition' => [
                        ...
                        'sa_social_icons_h_box_shadow_sep' => [
                            ...
                            'controller' => 'add_group_control',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-16.oxi-addons-social-style-16-{{KEY}} a.oxi-icon-style-16:hover' => ''
                            ], 'condition' => [
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-16 a.oxi-icon-style-16' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                    ],
                ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-16' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-16  a.oxi-icon-style-16 .oxi-icons' => 'font-size: {{SIZE}}{{UNIT}};'
                    ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#390075',
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-social-style-16  a.oxi-icon-style-16 .oxi-icons' => 'color : {{VALUE}}; '
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-social-style-16  a.oxi-icon-style-16 ' => 'background : {{VALUE}}; '
            ],
            'condition' => [
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-social-style-16 a.oxi-icon-style-16' => ''
            ],
            'condition' => [
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-16  a.oxi-icon-style-16' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#fff',
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-social-style-16  a.oxi-icon-style-16:hover .oxi-icons' => 'color : {{VALUE}}; '
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-social-style-16  a.oxi-icon-style-16:hover ' => 'background : {{VALUE}}; '
            ],
            'condition' => [
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BOXSHADOW,
            'selector' => [
                '{{WRAPPER}} .oxi-addons-social-style-16 a.oxi-icon-style-16:hover' => ''
            ],
            'condition' => [
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-16  a.oxi-icon-style-16:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
        );
        $this->end_controls_tab();
