    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_social_icons_color' => [
                        ...
                        'default' => '#ffffff',
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-11-{{KEY}} a.oxi-icon-style-11 .oxi-icons' => 'color:{{VALUE}};',
                        ],
                    ...
                    'sa_social_icons_color_hover' => [
                        ...
                        'default' => '#7e00c2',
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-11-{{KEY}} a.oxi-icon-style-11:hover .oxi-icons' => 'color:{{VALUE}};',
                        ],
                        'conditional' => Controls::OUTSIDE,
                        'condition' => [
                    ...
                    'sa_social_icons_bg_color' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-11-{{KEY}} a.oxi-icon-style-11' => 'background:{{VALUE}};',
                        ],
                        'conditional' => Controls::OUTSIDE,
                        'condition' => [
                    ...
                    'sa_social_icons_bg_color_hover' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-11-{{KEY}} a.oxi-icon-style-11:hover ' => 'background:{{VALUE}};',
                        ],
                        'conditional' => Controls::OUTSIDE,
                        'condition' => [
                    ...
                    'sa_social_icons_shadow' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-11-{{KEY}} a.oxi-icon-style-11:after' => ''
                        ],
                        'conditional' => Controls::OUTSIDE,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-11 a.oxi-icon-style-11' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-11' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-11  a.oxi-icon-style-11 .oxi-icons' => 'font-size: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#390075',
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-11  a.oxi-icon-style-11 .oxi-icons' => 'color : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-11  a.oxi-icon-style-11 ' => 'background : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-11  a.oxi-icon-style-11' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-11  a.oxi-icon-style-11:hover .oxi-icons' => 'color : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'rgba(92, 92, 92, 1)',
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-11  a.oxi-icon-style-11:hover ' => 'background : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_control(
            'sa_social_icons_h_box_shadow_view',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa_social_icons_h_box_shadow',
            $this->style,
            [
                'type' => Controls::BOXSHADOW,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-11 a.oxi-icon-style-11:after' => ''
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-11  a.oxi-icon-style-11:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
