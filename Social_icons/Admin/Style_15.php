    ...
    public function register_controls()
    {
            ...
            [
                ...
                'fields' => [
                    ...
                    'sa_social_icons_color' => [
                        ...
                        'default' => '#3b5999',
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-15-{{KEY}} a.oxi-icon-style-15 .oxi-icons' => 'color:{{VALUE}};',
                        ],
                    ...
                    'sa_social_icons_color_hover' => [
                        ...
                        'default' => '#fff',
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-15-{{KEY}} a.oxi-icon-style-15:hover .oxi-icons' => 'color:{{VALUE}};',
                        ],
                        'conditional' => Controls::OUTSIDE,
                        'condition' => [
                    ...
                    'sa_social_icons_bg_color' => [
                        ...
                        'selector' => [
                            '{{WRAPPER}} .oxi-addons-social-style-15-{{KEY}} a.oxi-icon-style-15' => 'background:{{VALUE}};',
                        ],
                        'conditional' => Controls::OUTSIDE,
                        'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15 a.oxi-icon-style-15' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15  a.oxi-icon-style-15 .oxi-icons' => 'font-size: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#390075',
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-15  a.oxi-icon-style-15 .oxi-icons' => 'color : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-15  a.oxi-icon-style-15 ' => 'background : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_control(
            'sa_social_icons_box_shadow_view',
            $this->style,
            [
        ...
        $this->add_group_control(
            'sa_social_icons_box_shadow',
            $this->style,
            [
                'type' => Controls::BOXSHADOW,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15 a.oxi-icon-style-15' => ''
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15  a.oxi-icon-style-15' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-15  a.oxi-icon-style-15:hover .oxi-icons' => 'color : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}}  .oxi-addons-social-style-15  a.oxi-icon-style-15:hover::after' => 'background : {{VALUE}}; '
                ],
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'type' => Controls::BOXSHADOW,
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15 a.oxi-icon-style-15:hover' => ''
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selector' => [
                    '{{WRAPPER}} .oxi-addons-social-style-15  a.oxi-icon-style-15:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
