    ...
    public function register_controls() {
                ...
                [
                    ...
                    'fields' => [
                        ...
                        'sa_social_icons_color' => [
                            ...
                            'default' => '#0075a3',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-6-{{KEY}} a.oxi-icon-style-6 .oxi-icons' => 'color:{{VALUE}};',
                            ],
                        ...
                        'sa_social_icons_color_hover' => [
                            ...
                            'default' => '#7e00c2',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-6-{{KEY}} a.oxi-icon-style-6:hover .oxi-icons' => 'color:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-6 a.oxi-icon-style-6' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-addons-social-style-6  a.oxi-icon-style-6 .oxi-icons' => 'font-size: {{SIZE}}{{UNIT}};'
                    ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '#390075',
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-social-style-6  a.oxi-icon-style-6 .oxi-icons' => 'color : {{VALUE}}; '
            ],
            'condition' => [
        ...
        $this->add_control(
            ...
            'default' => '#cc00a3',
            'selector' => [
                '{{WRAPPER}}  .oxi-addons-social-style-6  a.oxi-icon-style-6:hover .oxi-icons' => 'color : {{VALUE}}; '
            ],
            'condition' => [
