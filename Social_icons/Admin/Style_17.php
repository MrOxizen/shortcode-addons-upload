                ...
                [
                    ...
                    'fields' => [
                        ...
                        'sa_social_icons_color' => [
                            ...
                            'default' => '#8500c2',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-17-{{KEY}} a.oxi-icon-style-17 .oxi-icons' => 'color:{{VALUE}};',
                            ],
                        ...
                        'sa_social_icons_color_hover' => [
                            ...
                            'default' => '#fff',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-17-{{KEY}} a.oxi-icon-style-17:hover .oxi-icons' => 'color:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_bg_color' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-17-{{KEY}} a.oxi-icon-style-17' => 'background:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_bg_color_hover' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-17-{{KEY}} a.oxi-icon-style-17:hover ' => 'background:{{VALUE}};',
                            ],
                            'conditional' => Controls::OUTSIDE,
                            'condition' => [
                        ...
                        'sa_social_icons_box_shadow_sep' => [
                            ...
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-17-{{KEY}} a.oxi-icon-style-17' => ''
                            ], 'condition' => [
                        ...
                        'sa_social_icons_h_box_shadow_sep' => [
                            ...
                            'controller' => 'add_group_control',
                            'selector' => [
                                '{{WRAPPER}} .oxi-addons-social-style-17-{{KEY}} a.oxi-icon-style-17:hover' => ''
                            ], 'condition' => [
