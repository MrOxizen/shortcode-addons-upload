...
class Style_9 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($all_data as $key => $listitemdata) {
            ...
            echo '<div class = "oxi-addons-social-style-9  oxi-addons-social-style-9-' . $key . '"  ' . $this->animation_render('sa_social_icons_animation', $style) . '>
                        <a ' . $link . ' class = "oxi-icon-style-9 oxi-icon-item">' . $icon . '</a>
                    </div>';
        }
        echo '</div>';
    }
    ...
    foreach ($listdata as $value) {
        ...
        if ($styledata[79] == '') {
            $css .= '.oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '.oxi-icon-item-' . $value['id'] . '{
                        border: ' . $styledata[51] . 'px ' . $styledata[55] . '  ' . $listfiles[13] . ';
                    }
                    @media only screen and (min-width : 669px) and (max-width : 993px){
                        .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '.oxi-icon-item-' . $value['id'] . '{
                            border: ' . $styledata[52] . 'px ' . $styledata[55] . '  ' . $listfiles[13] . ';
                        }
                    }
                    @media only screen and (max-width : 668px){ 
                        .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '.oxi-icon-item-' . $value['id'] . '{
                            border: ' . $styledata[53] . 'px ' . $styledata[55] . '  ' . $listfiles[13] . ';
                        }
                    }';
        }
        if ($styledata[81] == '') {
            $css .= '.oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '.oxi-icon-item-' . $value['id'] . ':hover{
                       border: ' . $styledata[67] . 'px ' . $styledata[71] . '  ' . $listfiles[15] . ';
                    }
                    @media only screen and (min-width : 669px) and (max-width : 993px){
                        .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '.oxi-icon-item-' . $value['id'] . ':hover{
                            border: ' . $styledata[68] . 'px ' . $styledata[71] . '  ' . $listfiles[15] . ';
                         }
                    }
                    @media only screen and (max-width : 668px){ 
                        .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '.oxi-icon-item-' . $value['id'] . ':hover{
    ...
    $css .= '.oxi-addons-social-' . $oxiid . '{
                ...
                .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '{
                    ...
                    border: ' . $styledata[51] . 'px ' . $styledata[55] . '  ' . $styledata[56] . ';
                }
                .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . ':hover{
                   background: ' . $styledata[65] . ';
                    border: ' . $styledata[67] . 'px ' . $styledata[71] . '  ' . $styledata[72] . ';
                }
                @media only screen and (min-width : 669px) and (max-width : 993px){
                       ...
                       .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '{
                            border: ' . $styledata[52] . 'px ' . $styledata[55] . '  ' . $styledata[56] . ';
                        }
                        .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . ':hover{
                            border: ' . $styledata[68] . 'px ' . $styledata[71] . '  ' . $styledata[72] . ';
                        } 
                }
                @media only screen and (max-width : 668px){ 
                        .oxi-addons-social-' . $oxiid . '{
                       ...
                       .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . '{
                            border: ' . $styledata[53] . 'px ' . $styledata[55] . '  ' . $styledata[56] . ';
                        }
                        .oxi-addons-social-' . $oxiid . ' .oxi-icon-' . $oxiid . ':hover{
                            border: ' . $styledata[69] . 'px ' . $styledata[71] . '  ' . $styledata[72] . ';
                        } 
                }';
