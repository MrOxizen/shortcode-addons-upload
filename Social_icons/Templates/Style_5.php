...
class Style_5 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($all_data as $key => $listitemdata) {
            ...
            echo '<div class = "oxi-addons-social-style-5  oxi-addons-social-style-5-' . $key . '"  ' . $this->animation_render('sa_social_icons_animation', $style) . '>
                        <a ' . $link . ' class = "oxi-icon-style-5 oxi-icon-item">' . $icon . '</a>
                    </div>';
        }
        echo '</div>';
    }
