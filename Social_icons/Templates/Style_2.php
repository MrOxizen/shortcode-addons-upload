    ...
    public function default_render($style, $child, $admin) {
       ...
       echo '<div class="oxi-addons-center">';
        foreach ($all_data as $key => $listitemdata) {
            ...
            echo '<div class = "oxi-addons-social-style-2  oxi-addons-social-style-2-' . $key . '"  ' . $this->animation_render('sa_social_icons_animation', $style) . '>
                        <a ' . $link . ' class = "oxi-icon-style-2 oxi-icon-item">' . $icon . '</a>
                    </div>';
        }
        echo '</div>';
    }
