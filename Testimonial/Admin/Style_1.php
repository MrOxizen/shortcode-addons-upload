...
class Style_1 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testi-padding .oxi-testimonials-style-testi-image' => 'margin: 0 auto {{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
                'sa-testimonial-name-width', $this->style, [
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testi-padding .oxi-testimonials-style-testi-name' => 'width:{{SIZE}}{{UNIT}};',
            ],
                ]
        );

        $this->add_responsive_control(
                'sa-testimonial-name-height', $this->style, [
            'label' => __('Height', SHORTCODE_ADDOONS),
            'type' => Controls::SLIDER,
            'default' => [
                'unit' => 'px',
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testi-padding .oxi-testimonials-style-testi-name' => 'height:{{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
                'sa-testimonial-profile-name-border-redius', $this->style, [
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testi-padding .oxi-testimonials-style-testi-name' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-testimonials-testi-padding .oxi-testimonials-style-testi-rating' => 'text-align: {{VALUE}};'
            ],
                ]
        );
        $this->add_responsive_control(
