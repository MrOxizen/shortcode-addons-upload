...
class Style_9 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
                'sa_image_accordion_data_style_9', $this->style, [
            ...
            'fields' => [
                'sa_testi_profile_picture' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-nine-image-{{KEY}}' => '',
                    ]
                ],
                'sa_testi_profile_name' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-nine-name-{{KEY}}' => '',
                    ]
                ],
                ...
                'sa_testi_profile_destination' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-nine-working-{{KEY}}' => '',
                    ]
                ],
                'sa_testi_profile_description' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-testimonials-style-nine-info-{{KEY}}' => '',
                    ]
                ],
            ],
        ...
        $this->start_controls_section(
                'shortcode-addons', [
            'label' => esc_html__('Border Top & Bottom', SHORTCODE_ADDOONS),
            'showing' => FALSE,
                ]
        );
        $this->add_responsive_control(
                'sa-testimonial-profile-border-top-size', $this->style, [
            'label' => __('Border Top Size', SHORTCODE_ADDOONS),
            'type' => Controls::SLIDER,
            'default' => [
                'unit' => 'px',
                'size' => 3,
        ...
        $this->add_responsive_control(
                'sa-testimonial-profile-border-bottom-size', $this->style, [
        ...
        $this->add_control(
                'sa-testimonial-profile-tb-border-color', $this->style, [
            'label' => __('Color', SHORTCODE_ADDOONS),
            'type' => Controls::COLOR,
            'default' => '#787878',
            'selector' => [
        ...
        $this->add_control(
                'sa-testimonial-profile-tb-border-hover-color', $this->style, [
        ...
        $this->add_responsive_control(
                'sa-testimonial-profile-border-bottom-pointer-size', $this->style, [
            'label' => __('Border Bottom Pointer', SHORTCODE_ADDOONS),
            'type' => Controls::SLIDER,
            'default' => [
                'unit' => 'px',
                'size' => 10,
