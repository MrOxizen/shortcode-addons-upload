...
namespace SHORTCODE_ADDONS_UPLOAD\Elements\Call_to_action\Templates;
...
class Style_2 extends Templates
{
	public function default_render($style, $child, $admin)
	{
		...
		echo '<div class="sa_addons_cta_style_2">
	...
	public function old_render()
	{
		...
		$stylebutton = explode(':', $styledata[47]);
		$button = $button_layout = $heading = $sub_heading = '';
		if ($stylebutton[0] == 'left') {
			$button = 'left';
		} elseif ($stylebutton[0] == 'center') {
			$button = 'center';
		} else {
			$button = 'right';
		}
		...
		if (!empty($stylefiles[2])) {
			$button_layout = '<div class="oxi-addons-call-to-action-button-section">
