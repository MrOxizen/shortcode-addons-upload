...
class Style_1 extends Swiper_Settings_View
{
    ...
    public function render_team()
    {
        ...
        foreach ($child as $v) {
            ...
            echo '<div class="swiper-slide oxi-addons-parent-wrapper-style-1 oxi-addons-parent-wrapper-style-1-' . $v['id'] . ' sa_addons_carousel_item oxi-item ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ">
    ...
    public function default_render($style, $child, $admin)
    {
        ...
        $this->slider_default_render('sa_addons_team_carousel_style_1', $this->team_data);
    }
