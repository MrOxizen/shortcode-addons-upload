...
class Style_1 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        $oxiid = $this->oxiid;
        echo '<div class="sa_addons_carousel_style_1 sa_addons_carousel_style_1_' . $oxiid . '  ' . $styledata['sa_carousel_dot_posi'] . '  ' . $styledata['sa_carousel_dot_view'] . '">';
        ...
        foreach ($child as $v) {
            ...
            $icons_icon = ' <div class="member-icons">' . $icons . '</div>';


            echo '<div class="oxi-addons-parent-wrapper-style-1 oxi-addons-parent-wrapper-style-1-' . $v['id'] . ' sa_addons_carousel_item oxi-item ' . ($admin == "admin" ? 'oxi-addons-admin-edit-list' : '') . ' ">
                   <div class="oxi-team-show-body-style-1" >
