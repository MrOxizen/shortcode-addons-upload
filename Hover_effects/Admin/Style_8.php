...
class Style_8 extends AdminStyle {
    ...
    public function register_controls() {
        ...
        $this->add_repeater_control(
            ...
            'fields' => [
                ...
                'sa_he_title_color' => [
                    ...
                    'default' => '#000000',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-info h3.oxi-button-heading' => 'color:{{VALUE}};'
                    ],
                ],
                ...
                'sa_he_des_color' => [
                    ...
                    'default' => '#000000',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-info .oxi-button-content' => 'color:{{VALUE}};'
                    ],
                ],
                'sa_he_des_animation' => [
                    'label' => __('Animaton', SHORTCODE_ADDOONS),
                ...
                'sa_he_btn_color' => [
                    ...
                    'default' => '#000000',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-effects .oxi-he-button' => 'color:{{VALUE}};'
                    ],
                ],
                'sa_he_btn_bg' => [
                    ...
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-effects .oxi-he-button' => ''
                    ],
                ],
                'sa_oh_end_tab_2-1' => [
                    'controller' => 'end_controls_tab',
                ...
                'sa_he_btn_h_color' => [
                    ...
                    'default' => '#000000',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-effects .oxi-he-button:hover' => 'color:{{VALUE}};'
                    ],
                ],
                'sa_he_btn_h_bg' => [
                    'type' => Controls::BACKGROUND,
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-effects .oxi-he-button:hover' => ''
                    ],
                ],
                'sa_oh_end_tab_2-2' => [
                    'controller' => 'end_controls_tab',
                ...
                'sa_he_bg' => [
                    ...
                    'controller' => 'add_group_control',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-info' => ''
                    ],
                ],
                'sa_he_boxshadow' => [
                    ...
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-info' => '',
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-img:before' => ''
                    ],
                ],
                'sa_he_ul_color' => [
                    ...
                    'default' => 'red',
                    'selector' => [
                        '{{WRAPPER}} .oxi-hover-effects-style8.oxi-hover-effects-style8-{{KEY}} .oxi-hover-info .headingunderline' => 'border-color:{{VALUE}};'
                    ],
                ],
                'sa_he_effect' => [
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects-map-style8' => 'max-width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-img:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-img:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-img:hover img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8:hover .oxi-hover-img:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects:hover .oxi-hover-info' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info' => 'justify-content: {{VALUE}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info h3.oxi-button-heading' => ''
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info h3.oxi-button-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'include' => Controls::ALIGNNORMAL,
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info .oxi-button-content' => ''
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info .oxi-button-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info .headingunderline' => 'width:{{SIZE}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info .headingunderline' => 'border-width:{{SIZE}}px;'
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-info .headingunderline-body' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects  .oxi-hover-info-button' => 'text-align:{{VALUE}};'
            ],
                ]
        );
        $this->add_group_control(
            ...
            'type' => Controls::TYPOGRAPHY,
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects .oxi-he-button' => ''
            ],
                ]
        );
        $this->start_controls_tabs(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects .oxi-he-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_group_control(
            ...
            'type' => Controls::BORDER,
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects .oxi-he-button:hover' => '',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects .oxi-he-button:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects .oxi-he-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
        $this->add_responsive_control(
            ...
            'selector' => [
                '{{WRAPPER}} .oxi-hover-effects-style8 .oxi-hover-effects .oxi-he-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
            ],
                ]
        );
