...
class Style_18 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi-hover-effects-style18 oxi-hover-effects-style18-' . $key . '"  ' . $this->animation_render('sa_he_animation', $value) . '>';
            echo $link;
            echo '  <div class="oxi-hover-effects-map-style18">
           ...
           .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects  .oxi-hover-info-button{
            ...
            @media only screen and (max-width : 668px){
               ...
               .oxi-hover-effects-' . $oxiid . ' .oxi-hover-img img{
                ...
                .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects.oxi-hover-top-to-bottom .oxi-hover-info-before .oxi-hover-info {
                ...
                .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects.oxi-hover-top-to-bottom:hover .oxi-hover-info-before .oxi-hover-info{
                ...
                .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects.oxi-hover-bottom-to-top .oxi-hover-info-before .oxi-hover-info {
                    -webkit-transform: translate3d(0, 280px, 0) rotate3d(1, 0, 0, -90deg);
                    -moz-transform: translate3d(0, 280px, 0) rotate3d(1, 0, 0, -90deg);
                    -ms-transform: translate3d(0, 280px, 0) rotate3d(1, 0, 0, -90deg);
                    -o-transform: translate3d(0, 280px, 0) rotate3d(1, 0, 0, -90deg);
                ...
                .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects.oxi-hover-bottom-to-top:hover .oxi-hover-info-before .oxi-hover-info{
                    -webkit-transform: rotate3d(1, 0, 0, 0deg);
                    -moz-transform: rotate3d(1, 0, 0, 0deg);
                    -ms-transform: rotate3d(1, 0, 0, 0deg);
                    -o-transform: rotate3d(1, 0, 0, 0deg);
