...
class Style_12 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi-hover-effects-style12 oxi-hover-effects-style12-' . $key . '"  ' . $this->animation_render('sa_he_animation', $value) . '>';
            echo $link;
            echo '  <div class="oxi-hover-effects-map-style12">
    ...
    public function old_render() {
        ...
        $css = '.oxi-hover-effects-' . $oxiid . '{
           ...
           .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects  .oxi-hover-info-button{
            ...
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects .oxi-hover-info {
                opacity: 0;
                visibility: hidden;
                pointer-events: none;
