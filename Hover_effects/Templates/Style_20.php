...
class Style_20 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi-hover-effects-style20 oxi-hover-effects-style20-' . $key . '"  ' . $this->animation_render('sa_he_animation', $value) . '>';
            echo $link;
            echo '  <div class="oxi-hover-effects-map-style20">
    ...
    public function old_render() {
        ...
        $css = '.oxi-hover-effects-' . $oxiid . '{
           ...
           .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects  .oxi-hover-info-button{
            ...
            .image-ultimate-hover-<?php echo $styleid; ?> .oxi-hover-info {
                opacity: 0;
            }
            .image-ultimate-hover-<?php echo $styleid; ?>:hover .oxi-hover-info{
                opacity: 1;
            }
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects.oxi-hover-left-to-right:hover .oxi-hover-img{
