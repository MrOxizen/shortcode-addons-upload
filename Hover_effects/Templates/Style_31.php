...
class Style_31 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi-hover-effects-style31 oxi-hover-effects-style31-' . $key . '"  ' . $this->animation_render('sa_he_animation', $value) . '>';
            echo $link;
            echo '  <div class="oxi-hover-effects-map-style31">
    ...
    public function inline_public_jquery() {
        $jquery = ' function effects31heightstyle31() {
                var effects30height = jQuery(".oxi-hover-effects-style31 .oxi-hover-info .oxi-hover-data").outerHeight();
                jQuery("<style type=\'text/css\'> .oxi-hover-effects-style31 .oxi-hover-info .oxi-hover-info-data{transform: translateY(" + effects30height / 2 + "px); transform: -mos-translateY(" + effects30height / 2 + "px); transform: -webkit-translateY(" + effects30height / 2 + "px);} </style>").appendTo(".oxi-hover-effects-style31");
               }
            effects31heightstyle31();';
        return $jquery;
    }
    ...
    public function old_render() {
            ...
            echo '  <div class="oxi-hover-effects-map-' . $oxiid . '">
                    <div class="oxi-hover-effects-map-body">
                        <div class="oxi-hover-effects">
                            ...
                            <div class="oxi-hover-info"><div class="oxi-hover-info-data">';
            if ($valuefile[1] != '') {
        ...
        $css = '.oxi-hover-effects-' . $oxiid . '{
           ...
           .oxi-hover-effects-' . $oxiid . ' .oxi-hover-img img{
            ...
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects .oxi-hover-info .oxi-hover-info-data{
                width: 100%;
            }
           .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects:hover .oxi-hover-info .oxi-hover-info-data{
            ...
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects:hover  .oxi-hover-info h3.oxi-button-heading{
                 color: ' . $styledata[303] . ';
            }
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-info .oxi-hover-data{
                width: 100%;
                opacity:0;
            }
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects:hover .oxi-hover-info .oxi-hover-data{
                opacity:1;
            ...
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-effects:hover .headingunderline-body{
                opacity:1;
            }
        ...
        $jquery = ' function effects31height' . $oxiid . '() {
                var effects30height = jQuery(".oxi-hover-effects-' . $oxiid . ' .oxi-hover-info .oxi-hover-data").outerHeight();
                jQuery("<style type=\'text/css\'> .oxi-hover-effects-' . $oxiid . ' .oxi-hover-info .oxi-hover-info-data{transform: translateY(" + effects30height / 2 + "px); transform: -mos-translateY(" + effects30height / 2 + "px); transform: -webkit-translateY(" + effects30height / 2 + "px);} </style>").appendTo(".oxi-hover-effects-' . $oxiid . '");
               }
