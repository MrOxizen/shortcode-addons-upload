...
class Style_30 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi-hover-effects-style30 oxi-hover-effects-style30-' . $key . '"  ' . $this->animation_render('sa_he_animation', $value) . '>';
            echo $link;
            echo '  <div class="oxi-hover-effects-map-style30">
    ...
    $css = '.oxi-hover-effects-' . $oxiid . '{
           ...
           .oxi-hover-effects-' . $oxiid . ' .oxi-hover-img img{
            ...
            .oxi-hover-effects-' . $oxiid . ' .oxi-hover-info{
                ...
                margin: ' . OxiAddonsPaddingMarginSanitize($styledata, 13) . ';
                border-radius: ' . OxiAddonsPaddingMarginSanitize($styledata, 71) . ';
            }
