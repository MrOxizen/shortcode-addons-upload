...
class Style_16 extends Templates {
    ...
    public function default_render($style, $child, $admin) {
        ...
        foreach ($repeater as $key => $value) {
            ...
            echo '<div class="oxi-hover-effects-style16 oxi-hover-effects-style16-' . $key . '"  ' . $this->animation_render('sa_he_animation', $value) . '>';
            echo $link;
            echo '  <div class="oxi-hover-effects-map-style16">
