...
class Style_1 extends Templates {
    ...
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul:hover > li:hover,
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul > li:focus, 
    .oxi-addons-wrapper-' . $oxiid . ' .oxi-addons-accordion .oxi-addons-accordion-ul:focus-within > li:focus {
         width: 100%;
    }  
    .oxi-addons-accordion .oxi-addons-accordion-ul:hover > li:hover .oxi-link ,
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul > li:focus .oxi-link , 
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul:focus-within > li:focus .oxi-link  {
         background: ' . $styledata[23] . '
    } 
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul:hover > li:hover .oxi-link *,
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul > li:focus .oxi-link  *, 
    .oxi-addons-wrapper-' . $oxiid . '  .oxi-addons-accordion .oxi-addons-accordion-ul:focus-within > li:focus .oxi-link  * {
        opacity: 1;
